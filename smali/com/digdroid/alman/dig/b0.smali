...
.field private i:Lcom/digdroid/alman/dig/b0$j;

.field j:Lcom/digdroid/alman/dig/b0$k;
...
.method private constructor <init>(Landroid/content/Context;Lcom/digdroid/alman/dig/g3;Lcom/digdroid/alman/dig/o0;)V
    ...
    iput-object v0, p0, Lcom/digdroid/alman/dig/b0;->i:Lcom/digdroid/alman/dig/b0$j;

    iput-object v0, p0, Lcom/digdroid/alman/dig/b0;->j:Lcom/digdroid/alman/dig/b0$k;
    ...
    invoke-virtual {p0, v0}, Lcom/digdroid/alman/dig/b0;->x(Ljava/lang/String;)[Ljava/io/File;
...
.method public static declared-synchronized n(Landroid/content/Context;Lcom/digdroid/alman/dig/g3;Lcom/digdroid/alman/dig/o0;)Lcom/digdroid/alman/dig/b0;
    .locals 2
...
.method h(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 12
    ...
    invoke-direct/range {v0 .. v7}, Lcom/digdroid/alman/dig/b0$g;-><init>(Lcom/digdroid/alman/dig/b0;Landroid/view/View;Ljava/lang/String;Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;)V
...
.method i(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)Z
    .locals 9
    ...
    invoke-virtual/range {p0 .. p5}, Lcom/digdroid/alman/dig/b0;->l(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v2 .. v8}, Lcom/digdroid/alman/dig/b0;->h(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v2 .. v8}, Lcom/digdroid/alman/dig/b0;->k(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;Ljava/lang/String;)Z
...
.method j(Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v2, v3}, Lcom/digdroid/alman/dig/a3;->v(J)Ljava/lang/String;
...
.method k(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 2

    new-instance p1, Lcom/digdroid/alman/dig/a3;

    iget-object p3, p0, Lcom/digdroid/alman/dig/b0;->b:Landroid/content/Context;

    invoke-direct {p1, p3}, Lcom/digdroid/alman/dig/a3;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/digdroid/alman/dig/a3;->v(J)Ljava/lang/String;
    ...
    invoke-virtual {p2, p6}, Landroid/content/Intent;->setData(Landroid/net/Uri;)Landroid/content/Intent;

    const-string p6, "android.intent.action.VIEW"

    invoke-virtual {p2, p6}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    iput-object p4, p1, Lcom/digdroid/alman/dig/n;->b:Ljava/lang/String;

    invoke-virtual {p1, p5}, Lcom/digdroid/alman/dig/n;->r(Ljava/lang/String;)Z

    :cond_0
    return p3
.end method

.method l(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)Z
    .locals 9
    ...
    new-instance v1, Lcom/digdroid/alman/dig/b0$h;
    ...
    invoke-direct/range {v2 .. v8}, Lcom/digdroid/alman/dig/b0$h;-><init>(Lcom/digdroid/alman/dig/b0;Landroid/view/View;Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;)V
...
.method m(Landroid/content/Context;Landroid/database/Cursor;Landroid/database/Cursor;)Ljava/lang/String;
    .locals 7
...
.method o(Landroid/database/Cursor;)Z
    .locals 2
...
.method p(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Z)V
    .locals 10
    ...
    invoke-static {p1, v0}, Lcom/digdroid/alman/dig/y3;->n(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/digdroid/alman/dig/b0;->i:Lcom/digdroid/alman/dig/b0$j;
    ...
    invoke-interface/range {v3 .. v9}, Lcom/digdroid/alman/dig/b0$j;->s0(JJLjava/lang/String;Z)V
...
.method q(Lcom/digdroid/alman/dig/x3;JLjava/lang/String;)V
    .locals 3
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, v0, p4}, Lcom/digdroid/alman/dig/b0;->t(Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)V

    return-void
.end method

.method r(Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Z)V
    .locals 2
    ...
    invoke-direct {v1, p0, p2, p3, p1}, Lcom/digdroid/alman/dig/b0$c;-><init>(Lcom/digdroid/alman/dig/b0;Landroid/database/Cursor;Landroid/database/Cursor;Lcom/digdroid/alman/dig/x3;)V

    invoke-static {p1, v0, p3, p4, v1}, Lcom/digdroid/alman/dig/t2;->b(Lcom/digdroid/alman/dig/x3;Lcom/digdroid/alman/dig/g3;Landroid/database/Cursor;ZLcom/digdroid/alman/dig/t2$b;)V

    return-void
.end method

.method s(Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)V
    .locals 10
    ...
    invoke-direct/range {v3 .. v8}, Lcom/digdroid/alman/dig/b0$d;-><init>(Lcom/digdroid/alman/dig/b0;Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)V
...
.method t(Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)V
    .locals 17
    ...
    invoke-static/range {p4 .. p4}, Lcom/digdroid/alman/dig/e4;->c(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lcom/digdroid/alman/dig/y3;->c(Landroid/content/Context;)V

    iget-object v1, v6, Lcom/digdroid/alman/dig/b0;->b:Landroid/content/Context;

    invoke-static {v1}, Lcom/digdroid/alman/dig/y3;->y(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-virtual/range {v9 .. v16}, Lcom/digdroid/alman/dig/x3;->e1(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-virtual {v6, v7}, Lcom/digdroid/alman/dig/b0;->o(Landroid/database/Cursor;)Z
    ...
    invoke-virtual {v6, v10, v8, v7}, Lcom/digdroid/alman/dig/b0;->m(Landroid/content/Context;Landroid/database/Cursor;Landroid/database/Cursor;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/digdroid/alman/dig/x2;->y(I)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/digdroid/alman/dig/b0;->i(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/digdroid/alman/dig/b0;->p(Lcom/digdroid/alman/dig/x3;Landroid/content/Intent;Landroid/database/Cursor;Landroid/database/Cursor;Z)V

    :cond_e
    return-void
.end method

.method public u(Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Z)V
    .locals 8
    ...
    invoke-static {v0, v4}, Lcom/digdroid/alman/dig/y3;->r(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/digdroid/alman/dig/b0;->r(Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Z)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/digdroid/alman/dig/b0$a;-><init>(Lcom/digdroid/alman/dig/b0;Lcom/digdroid/alman/dig/x3;Ljava/lang/String;Landroid/database/Cursor;Landroid/database/Cursor;)V
...
.method v(Landroid/app/Activity;JJZ)V
    .locals 8
    ...
    :cond_0
    iget-object v0, p0, Lcom/digdroid/alman/dig/b0;->j:Lcom/digdroid/alman/dig/b0$k;

    if-eqz v0, :cond_1

    invoke-interface {v0}, Lcom/digdroid/alman/dig/b0$k;->a()V
    ...
    new-instance v4, Lcom/digdroid/alman/dig/b0$i;

    invoke-direct {v4, p0, v2, p1}, Lcom/digdroid/alman/dig/b0$i;-><init>(Lcom/digdroid/alman/dig/b0;ILandroid/app/Activity;)V
...
.method w(Lcom/digdroid/alman/dig/x3;J)V
    .locals 15
    ...
    iget-object v3, v6, Lcom/digdroid/alman/dig/b0;->b:Landroid/content/Context;

    invoke-static {v3}, Lcom/digdroid/alman/dig/y3;->y(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-virtual {p0, v2, v3, v4, v0}, Lcom/digdroid/alman/dig/b0;->t(Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/digdroid/alman/dig/b0$f;-><init>(Lcom/digdroid/alman/dig/b0;Lcom/digdroid/alman/dig/x3;Landroid/database/Cursor;Landroid/database/Cursor;Ljava/util/ArrayList;)V
...
.method public y(Lcom/digdroid/alman/dig/b0$j;)V
    .locals 0

    iput-object p1, p0, Lcom/digdroid/alman/dig/b0;->i:Lcom/digdroid/alman/dig/b0$j;
