...
.field o:Lcom/digdroid/alman/dig/b3;
...
.field s:Lcom/digdroid/alman/dig/g3;
...
.method public constructor <init>(Lcom/digdroid/alman/dig/MainActivity;Lcom/digdroid/alman/dig/s3;Landroid/database/Cursor;FFLjava/lang/String;Z)V
    ...
    iput-object p1, p0, Lcom/digdroid/alman/dig/i3;->p:Landroid/app/Activity;

    iput-object p6, p0, Lcom/digdroid/alman/dig/i3;->q:Ljava/lang/String;

    iput-boolean p7, p0, Lcom/digdroid/alman/dig/i3;->r:Z

    invoke-static {p1}, Lcom/digdroid/alman/dig/b3;->k(Landroid/content/Context;)Lcom/digdroid/alman/dig/b3;

    move-result-object p2

    iput-object p2, p0, Lcom/digdroid/alman/dig/i3;->o:Lcom/digdroid/alman/dig/b3;

    invoke-static {p1}, Lcom/digdroid/alman/dig/u;->e(Landroid/content/Context;)Lcom/digdroid/alman/dig/u;

    move-result-object p2

    invoke-static {p1, p2}, Lcom/digdroid/alman/dig/g3;->q(Landroid/content/Context;Lcom/digdroid/alman/dig/u;)Lcom/digdroid/alman/dig/g3;

    move-result-object p2

    iput-object p2, p0, Lcom/digdroid/alman/dig/i3;->s:Lcom/digdroid/alman/dig/g3;
    ...
    iput-object p2, p0, Lcom/digdroid/alman/dig/i3;->m:Ljava/lang/String;

    :cond_0
    iget-object p2, p0, Lcom/digdroid/alman/dig/h;->c:Lcom/digdroid/alman/dig/s3;

    iget-object p2, p2, Lcom/digdroid/alman/dig/s3;->t:Ljava/lang/String;

    iput-object p2, p0, Lcom/digdroid/alman/dig/i3;->l:Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/digdroid/alman/dig/i3;->m:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/digdroid/alman/dig/i3;->n:Landroid/content/res/Resources;
...
.method A(Landroid/widget/ImageView;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget-object v1, p0, Lcom/digdroid/alman/dig/i3;->s:Lcom/digdroid/alman/dig/g3;
    ...
    iget-object v3, p0, Lcom/digdroid/alman/dig/i3;->l:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/digdroid/alman/dig/i3;->m:Ljava/lang/String;
...
.method public j(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
    ...
    iget-object p2, p1, Lcom/digdroid/alman/dig/i3$a;->t:Landroid/widget/ImageView;

    iget-object v0, p0, Lcom/digdroid/alman/dig/i3;->p:Landroid/app/Activity;

    iget-object v1, p0, Lcom/digdroid/alman/dig/h;->d:Landroid/database/Cursor;

    invoke-virtual {p0, p2, v0, v1}, Lcom/digdroid/alman/dig/i3;->A(Landroid/widget/ImageView;Landroid/content/Context;Landroid/database/Cursor;)V

    iget-boolean p2, p0, Lcom/digdroid/alman/dig/i3;->r:Z
    ...
    :cond_1
    iget-object p2, p1, Lcom/digdroid/alman/dig/i3$a;->u:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lcom/digdroid/alman/dig/i3;->n:Landroid/content/res/Resources;
    ...
    iget-object v0, p0, Lcom/digdroid/alman/dig/i3;->q:Ljava/lang/String;
    ...
    :cond_2
    iget-object p1, p1, Lcom/digdroid/alman/dig/i3$a;->v:Landroid/widget/TextView;
