...
public class C0795h {
    ...
    /* renamed from: a */
    final ArrayList<C1028w> f3990a = new ArrayList<>();

    /* renamed from: b */
    private long f3991b = -1;

    /* renamed from: c */
    private Interpolator f3992c;

    /* renamed from: d */
    AbstractC1032x f3993d;

    /* renamed from: e */
    private boolean f3994e;

    /* renamed from: f */
    private final C1033y f3995f = new C0796a();
    ...
    class C0796a extends C1033y {
        ...
        public void mo345a(View view) {
            int i = this.f3997b + 1;
            this.f3997b = i;
            if (i == C0795h.this.f3990a.size()) {
                AbstractC1032x xVar = C0795h.this.f3993d;
                if (xVar != null) {
                    xVar.mo345a(null);
                }
                mo4732d();
    ...
    public void mo4724a() {
        if (this.f3994e) {
            Iterator<C1028w> it = this.f3990a.iterator();
            while (it.hasNext()) {
                it.next().mo5579b();
            }
            this.f3994e = false;
    ...
    public void mo4731h() {
        if (!this.f3994e) {
            ...
            while (it.hasNext()) {
                ...
                Interpolator interpolator = this.f3992c;
                if (interpolator != null) {
                    next.mo5582e(interpolator);
                }
                if (this.f3993d != null) {
                    next.mo5583f(this.f3995f);
                }
                next.mo5586j();
            }
            this.f3994e = true;
