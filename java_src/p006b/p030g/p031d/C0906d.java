...
public class C0906d {
    ...
    /* renamed from: a */
    private static final C0912j f4537a;

    /* renamed from: b */
    private static final C0831g<String, Typeface> f4538b = new C0831g<>(16);

    static {
        int i = Build.VERSION.SDK_INT;
        f4537a = i >= 29 ? new C0911i() : i >= 28 ? new C0910h() : i >= 26 ? new C0909g() : (i < 24 || !C0908f.m5335m()) ? i >= 21 ? new C0907e() : new C0912j() : new C0908f();
    }
    ...
    public static Typeface m5320b(Context context, CancellationSignal cancellationSignal, C0923b.C0929f[] fVarArr, int i) {
        return f4537a.mo5306c(context, cancellationSignal, fVarArr, i);
    }
    ...
    public static Typeface m5321c(Context context, C0382c.AbstractC0383a aVar, Resources resources, int i, int i2, C0390f.AbstractC0391a aVar2, Handler handler, boolean z) {
        ...
        if (aVar instanceof C0382c.C0386d) {
            ...
            typeface = f4537a.mo5305b(context, (C0382c.C0384b) aVar, resources, i2);
            if (aVar2 != null) {
                if (typeface != null) {
        ...
        if (typeface != null) {
            f4538b.mo4930f(m5323e(resources, i, i2), typeface);
        }
        return typeface;
    }
    ...
    public static Typeface m5322d(Context context, Resources resources, int i, String str, int i2) {
        Typeface e = f4537a.mo5308e(context, resources, i, str, i2);
        if (e != null) {
            f4538b.mo4930f(m5323e(resources, i, i2), e);
        }
        return e;
    }
    ...
    public static Typeface m5324f(Resources resources, int i, int i2) {
        return f4538b.mo4928d(m5323e(resources, i, i2));
    }
