...
public class C0867f extends C0874l {
    ...
    /* renamed from: A0 */
    private boolean f4346A0 = false;

    /* renamed from: B0 */
    public C0849e f4347B0;

    /* renamed from: C0 */
    protected C0846d f4348C0 = new C0846d();
    ...
    /* renamed from: J0 */
    C0860c[] f4355J0 = new C0860c[4];

    /* renamed from: K0 */
    C0860c[] f4356K0 = new C0860c[4];
    ...
    /* renamed from: O0 */
    public int f4360O0 = 0;

    /* renamed from: P0 */
    public int f4361P0 = 0;

    /* renamed from: Q0 */
    private int f4362Q0 = 263;

    /* renamed from: R0 */
    public boolean f4363R0 = false;

    /* renamed from: S0 */
    private boolean f4364S0 = false;

    /* renamed from: T0 */
    private boolean f4365T0 = false;

    /* renamed from: U0 */
    int f4366U0 = 0;

    /* renamed from: x0 */
    C0876b f4367x0 = new C0876b(this);

    /* renamed from: y0 */
    public C0881e f4368y0 = new C0881e(this);

    /* renamed from: z0 */
    protected C0876b.AbstractC0878b f4369z0 = null;

    /* renamed from: M0 */
    private void m5158M0(C0864e eVar) {
        int i = this.f4353H0 + 1;
        C0860c[] cVarArr = this.f4356K0;
        if (i >= cVarArr.length) {
            this.f4356K0 = (C0860c[]) Arrays.copyOf(cVarArr, cVarArr.length * 2);
        }
        this.f4356K0[this.f4353H0] = new C0860c(eVar, 0, mo5238W0());
        this.f4353H0++;
    }

    /* renamed from: N0 */
    private void m5159N0(C0864e eVar) {
        int i = this.f4354I0 + 1;
        C0860c[] cVarArr = this.f4355J0;
        if (i >= cVarArr.length) {
            this.f4355J0 = (C0860c[]) Arrays.copyOf(cVarArr, cVarArr.length * 2);
        }
        this.f4355J0[this.f4354I0] = new C0860c(eVar, 1, mo5238W0());
        this.f4354I0++;
    }
    ...
    public void mo5161F0(boolean z, boolean z2) {
        ...
        for (int i = 0; i < size; i++) {
            this.f4393w0.get(i).mo5161F0(z, z2);
        }
    }
    ...
    public boolean mo5229L0(C0846d dVar) {
        ...
        if (z) {
            for (int i2 = 0; i2 < size; i2++) {
                C0864e eVar2 = this.f4393w0.get(i2);
        ...
        for (int i3 = 0; i3 < size; i3++) {
            C0864e eVar3 = this.f4393w0.get(i3);
            if (eVar3.mo5186e()) {
                eVar3.mo5133f(dVar);
            }
        }
        for (int i4 = 0; i4 < size; i4++) {
            C0864e eVar4 = this.f4393w0.get(i4);
            if (eVar4 instanceof C0867f) {
                C0864e.EnumC0866b[] bVarArr = eVar4.f4279N;
    ...
    public boolean mo5230O0(boolean z) {
        return this.f4368y0.mo5274f(z);
    }

    /* renamed from: P0 */
    public boolean mo5231P0(boolean z) {
        return this.f4368y0.mo5275g(z);
    }

    /* renamed from: Q0 */
    public boolean mo5232Q0(boolean z, int i) {
        return this.f4368y0.mo5276h(z, i);
    }
    ...
    public void mo5235T0() {
        this.f4368y0.mo5277j();
    }

    /* renamed from: U0 */
    public void mo5236U0() {
        this.f4368y0.mo5278k();
    }
    ...
    public long mo5240Y0(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        this.f4349D0 = i8;
        this.f4350E0 = i9;
        return this.f4367x0.mo5263d(this, i, i8, i9, i2, i3, i4, i5, i6, i7);
    }

    /* renamed from: Z0 */
    public boolean mo5241Z0(int i) {
        return (this.f4362Q0 & i) == i;
    }

    /* renamed from: b1 */
    public void mo5242b1(C0876b.AbstractC0878b bVar) {
        this.f4369z0 = bVar;
        this.f4368y0.mo5280n(bVar);
    }

    /* renamed from: c1 */
    public void mo5243c1(int i) {
        this.f4362Q0 = i;
        C0846d.f4155c = C0872j.m5202b(i, 256);
    }
    ...
    public void mo5245e1(C0846d dVar, boolean[] zArr) {
        ...
        int size = this.f4393w0.size();
        for (int i = 0; i < size; i++) {
            this.f4393w0.get(i).mo5163G0(dVar);
        }
    }

    /* renamed from: f1 */
    public void mo5246f1() {
        this.f4367x0.mo5264e(this);
    }
}
