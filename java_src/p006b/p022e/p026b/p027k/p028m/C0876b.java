...
public class C0876b {
    ...
    /* renamed from: a */
    private final ArrayList<C0864e> f4394a = new ArrayList<>();

    /* renamed from: b */
    private C0877a f4395b = new C0877a();

    /* renamed from: c */
    private C0867f f4396c;

    /* renamed from: b.e.b.k.m.b$a */
    public static class C0877a {

        /* renamed from: a */
        public C0864e.EnumC0866b f4397a;

        /* renamed from: b */
        public C0864e.EnumC0866b f4398b;
    ...
    private boolean m5212a(AbstractC0878b bVar, C0864e eVar, boolean z) {
        this.f4395b.f4397a = eVar.mo5219w();
        this.f4395b.f4398b = eVar.mo5167K();
        this.f4395b.f4399c = eVar.mo5170N();
        this.f4395b.f4400d = eVar.mo5213t();
        C0877a aVar = this.f4395b;
        aVar.f4405i = false;
        aVar.f4406j = z;
        C0864e.EnumC0866b bVar2 = aVar.f4397a;
        C0864e.EnumC0866b bVar3 = C0864e.EnumC0866b.MATCH_CONSTRAINT;
        boolean z2 = bVar2 == bVar3;
        boolean z3 = aVar.f4398b == bVar3;
        boolean z4 = z2 && eVar.f4283R > 0.0f;
        boolean z5 = z3 && eVar.f4283R > 0.0f;
        if (z4 && eVar.f4319o[0] == 4) {
            aVar.f4397a = C0864e.EnumC0866b.FIXED;
        }
        if (z5 && eVar.f4319o[1] == 4) {
            aVar.f4398b = C0864e.EnumC0866b.FIXED;
        }
        bVar.mo1969a(eVar, aVar);
        eVar.mo5153B0(this.f4395b.f4401e);
        eVar.mo5187e0(this.f4395b.f4402f);
        eVar.mo5185d0(this.f4395b.f4404h);
        eVar.mo5180Y(this.f4395b.f4403g);
        C0877a aVar2 = this.f4395b;
        aVar2.f4406j = false;
        return aVar2.f4405i;
    }
    ...
    private void m5213b(C0867f fVar) {
        int size = fVar.f4393w0.size();
        AbstractC0878b R0 = fVar.mo5233R0();
        for (int i = 0; i < size; i++) {
            C0864e eVar = fVar.f4393w0.get(i);
            if (!(eVar instanceof C0868g) && (!eVar.f4301f.f4457e.f4427j || !eVar.f4303g.f4457e.f4427j)) {
                ...
                if (q != bVar || eVar.f4315m == 1 || q2 != bVar || eVar.f4317n == 1) {
                    z = false;
                }
                if (z) {
                    continue;
    ...
    public long mo5263d(C0867f fVar, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (z6) {
            ...
            while (true) {
                ...
                C0864e eVar = fVar.f4393w0.get(i15);
        ...
        if (!z6 || C0846d.f4154b == null) {
            ...
            if (size2 > 0) {
                ...
                int max = Math.max(fVar.mo5170N(), this.f4396c.mo5154C());
                int max2 = Math.max(fVar.mo5213t(), this.f4396c.mo5152B());
                int i16 = 0;
                boolean z10 = false;
                while (i16 < size2) {
                    C0864e eVar2 = this.f4394a.get(i16);
                ...
                while (i17 < i18) {
                    int i19 = 0;
                    while (i19 < size2) {
                        C0864e eVar3 = this.f4394a.get(i19);
                        if ((!(eVar3 instanceof AbstractC0870h) || (eVar3 instanceof C0873k)) && !(eVar3 instanceof C0868g) && eVar3.mo5169M() != 8 && ((!eVar3.f4301f.f4457e.f4427j || !eVar3.f4303g.f4457e.f4427j) && !(eVar3 instanceof C0873k))) {
