...
public class C0868g extends C0864e {
    ...
    /* renamed from: w0 */
    protected float f4372w0 = -1.0f;

    /* renamed from: x0 */
    protected int f4373x0 = -1;

    /* renamed from: y0 */
    protected int f4374y0 = -1;

    /* renamed from: z0 */
    private C0861d f4375z0 = this.f4269D;
    ...
    public C0868g() {
        ...
        this.f4371B0 = 0;
        this.f4277L.clear();
        this.f4277L.add(this.f4375z0);
        int length = this.f4276K.length;
        for (int i = 0; i < length; i++) {
            this.f4276K[i] = this.f4375z0;
        }
    }
    ...
    public void mo5163G0(C0846d dVar) {
        if (mo5158E() != null) {
            int x = dVar.mo5103x(this.f4375z0);
            if (this.f4370A0 == 1) {
                mo5155C0(x);
                mo5157D0(0);
    ...
    public void mo5254O0(int i) {
        if (this.f4370A0 != i) {
            this.f4370A0 = i;
            this.f4277L.clear();
            this.f4375z0 = this.f4370A0 == 1 ? this.f4268C : this.f4269D;
            this.f4277L.add(this.f4375z0);
            int length = this.f4276K.length;
            for (int i2 = 0; i2 < length; i2++) {
                this.f4276K[i2] = this.f4375z0;
            }
        }
    }
    ...
    public void mo5133f(C0846d dVar) {
        ...
        if (fVar != null) {
            ...
            C0864e eVar = this.f4280O;
            boolean z = true;
            boolean z2 = eVar != null && eVar.f4279N[0] == C0864e.EnumC0866b.WRAP_CONTENT;
            if (this.f4370A0 == 0) {
                k = fVar.mo5195k(C0861d.EnumC0863b.TOP);
                k2 = fVar.mo5195k(C0861d.EnumC0863b.BOTTOM);
                C0864e eVar2 = this.f4280O;
                if (eVar2 == null || eVar2.f4279N[1] != C0864e.EnumC0866b.WRAP_CONTENT) {
                    z = false;
                }
                z2 = z;
            }
            if (this.f4373x0 != -1) {
                C0855i q = dVar.mo5099q(this.f4375z0);
                dVar.mo5089e(q, dVar.mo5099q(k), this.f4373x0, 8);
                if (z2) {
                    dVar.mo5092h(dVar.mo5099q(k2), q, 0, 5);
                }
            } else if (this.f4374y0 != -1) {
                C0855i q2 = dVar.mo5099q(this.f4375z0);
                C0855i q3 = dVar.mo5099q(k2);
                dVar.mo5089e(q2, q3, -this.f4374y0, 8);
                if (z2) {
                    dVar.mo5092h(q2, dVar.mo5099q(k), 0, 5);
                    dVar.mo5092h(q3, q2, 0, 5);
                }
            } else if (this.f4372w0 != -1.0f) {
                dVar.mo5088d(C0846d.m4979s(dVar, dVar.mo5099q(this.f4375z0), dVar.mo5099q(k2), this.f4372w0));
            }
        }
    }
    ...
    public C0861d mo5195k(C0861d.EnumC0863b bVar) {
        switch (C0869a.f4376a[bVar.ordinal()]) {
            case 1:
            case 2:
                if (this.f4370A0 == 1) {
                    return this.f4375z0;
