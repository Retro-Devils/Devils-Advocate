...
public class CarouselLayoutManager extends RecyclerView.AbstractC0669o {
    ...
    /* renamed from: s */
    private static final String f11022s = "CarouselLayoutManager";

    /* renamed from: t */
    public static final C1546a.AbstractC1558l f11023t = new C1539c(new C1541e());

    /* renamed from: u */
    public static final C1546a.AbstractC1557k f11024u = new C1536b();

    /* renamed from: A */
    private int f11025A = 1;

    /* renamed from: B */
    private Queue<Runnable> f11026B = new LinkedList();

    /* renamed from: C */
    private Handler f11027C = new Handler();

    /* renamed from: D */
    private RecyclerView f11028D = null;
    ...
    /* renamed from: G */
    private int f11031G = 0;

    /* renamed from: H */
    private int f11032H = 0;

    /* renamed from: I */
    private int f11033I = 0;

    /* renamed from: J */
    private int f11034J = 0;

    /* renamed from: K */
    private boolean f11035K = false;

    /* renamed from: L */
    private boolean f11036L = false;

    /* renamed from: M */
    private int f11037M = 0;

    /* renamed from: N */
    private C1546a.AbstractC1558l f11038N = f11023t;

    /* renamed from: O */
    private C1546a.AbstractC1557k f11039O;

    /* renamed from: v */
    private C1546a.AbstractC1553g f11040v = null;

    /* renamed from: w */
    private C1546a.AbstractC1554h f11041w = null;

    /* renamed from: x */
    private boolean f11042x = true;

    /* renamed from: y */
    private C1546a.EnumC1552f f11043y = C1546a.EnumC1552f.FirstBack;

    /* renamed from: z */
    private int f11044z = 0;
    ...
    public class RunnableC3299a implements Runnable {
        ...
        public void run() {
            while (!this.f11045b.isEmpty()) {
                ((Runnable) this.f11045b.poll()).run();
            }
        }
    }
    ...
    public class View$OnClickListenerC3300b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (CarouselLayoutManager.this.f11040v != null) {
                C1546a.AbstractC1553g gVar = CarouselLayoutManager.this.f11040v;
                int i = this.f11047b;
    ...
    public class View$OnLongClickListenerC3301c implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            if (CarouselLayoutManager.this.f11041w == null) {
                return false;
            }
            C1546a.AbstractC1554h hVar = CarouselLayoutManager.this.f11041w;
            int i = this.f11049b;
    ...
    public class RunnableC3302d implements Runnable {
        ...
        public void run() {
            CarouselLayoutManager.this.mo3360E1(this.f11051b);
        }
    }
    ...
    public class RunnableC3303e implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ RecyclerView f11053b;

        /* renamed from: c */
        final /* synthetic */ RecyclerView.C0649a0 f11054c;
        ...
        public void run() {
            CarouselLayoutManager.this.mo3385Q1(this.f11053b, this.f11054c, this.f11055d);
        }
    }
    ...
    public static /* synthetic */ class C3304f {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.gtomato.android.p149ui.manager.CarouselLayoutManager.C3304f.f11057a = r0
                c.c.a.a.c.a$f r1 = p069c.p111c.p112a.p113a.p116c.C1546a.EnumC1552f.FirstBack     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = com.gtomato.android.p149ui.manager.CarouselLayoutManager.C3304f.f11057a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.gtomato.android.p149ui.manager.CarouselLayoutManager.C3304f.f11057a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.gtomato.android.p149ui.manager.CarouselLayoutManager.C3304f.f11057a     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    private void m13809C2() {
        int i = this.f11025A & 7;
        this.f11031G = i != 3 ? i != 5 ? ((((this.f11033I - mo4127i0()) - mo4129j0()) - this.f11029E) / 2) + mo4127i0() : (this.f11033I - mo4129j0()) - this.f11029E : mo4127i0();
        int i2 = this.f11025A & 112;
        this.f11032H = i2 != 16 ? i2 != 80 ? mo4131k0() : (this.f11034J - mo4124h0()) - this.f11030F : ((((this.f11034J - mo4131k0()) - mo4124h0()) - this.f11030F) / 2) + mo4131k0();
    }
    ...
    private void m13812X1(int i, C1559a<View> aVar, RecyclerView.C0681v vVar, RecyclerView.C0649a0 a0Var) {
        ...
        if (!a0Var.mo3950h()) {
            int i2 = this.f11031G;
            int i3 = this.f11032H;
            mo4084E0(b, i2, i3, i2 + this.f11029E, i3 + this.f11030F);
            this.f11038N.mo6829b(b, -(mo11180q2(this.f11037M) - ((float) i)));
        }
    }

    /* renamed from: Z1 */
    private int m13813Z1() {
        return this.f11037M - (m13815b2() / 2);
    }
    ...
    private int m13815b2() {
        return (this.f11033I - mo4129j0()) - mo4127i0();
    }

    /* renamed from: h2 */
    private int m13816h2() {
        int floor = ((int) Math.floor((double) mo11180q2(m13813Z1()))) - this.f11044z;
        return this.f11042x ? floor : Math.max(floor, 0);
    }

    /* renamed from: i2 */
    private int m13817i2() {
        int ceil = ((int) Math.ceil((double) mo11180q2(m13814a2()))) + this.f11044z;
        return this.f11042x ? ceil : Math.min(ceil, mo4116c0() - 1);
    }
    ...
    private static void m13818n2(String str, Object... objArr) {
        ...
        if (objArr.length > 0) {
            Log.d(f11022s, String.format(str, objArr));
        } else {
            Log.d(f11022s, str);
        }
    }
    ...
    private static void m13819o2(String str, Object... objArr) {
        ...
        if (objArr.length > 0) {
            Log.v(f11022s, String.format(str, objArr));
        } else {
            Log.v(f11022s, str);
        }
    }
    ...
    private void m13820p2(RecyclerView.C0681v vVar) {
        ...
        if (mo4098M() == 0 || this.f11029E * this.f11030F == 0) {
            View o = vVar.mo4215o(0);
            mo4117d(o);
            mo4086G0(o, 0, 0);
            this.f11029E = mo4110W(o);
            this.f11030F = mo4109V(o);
            m13818n2("child width = " + this.f11029E + ", height = " + this.f11030F + ", my width = " + mo4143s0(), new Object[0]);
    ...
    public CarouselLayoutManager mo11168A2(C1546a.AbstractC1558l lVar) {
        C1546a.AbstractC1558l lVar2 = this.f11038N;
        C1546a.AbstractC1558l lVar3 = lVar != null ? lVar : f11023t;
        this.f11038N = lVar3;
        if (lVar3 != lVar2) {
            mo11182s2();
            lVar.mo6830c(this);
    ...
    public int mo3359D1(int i, RecyclerView.C0681v vVar, RecyclerView.C0649a0 a0Var) {
        C1546a.AbstractC1557k kVar = this.f11039O;
        if (kVar != null) {
            i = kVar.mo6828c(i);
        }
        if (!this.f11042x) {
            int i2 = this.f11037M;
            if (i2 + i >= 0) {
                int c0 = this.f11029E * (mo4116c0() - 1);
                int i3 = this.f11037M;
                if (i3 + i > c0) {
                    if (i3 < c0) {
                        i = c0 - i3;
        ...
        C1546a.AbstractC1557k kVar2 = this.f11039O;
    ...
    public void mo3360E1(int i) {
        ...
        if (this.f11029E != 0 || mo4116c0() <= 0) {
            int i2 = this.f11029E * i;
            m13818n2("scrollToPosition " + i + "scrollOffset " + this.f11037M + " -> " + i2, new Object[0]);
            double abs = (double) Math.abs(i2 - this.f11037M);
            double d = (double) this.f11029E;
            Double.isNaN(d);
            if (abs > d * 1.5d) {
                this.f11036L = true;
            ...
            this.f11037M = i2;
            if (Build.VERSION.SDK_INT >= 18 && (recyclerView = this.f11028D) != null && !recyclerView.isInLayout()) {
                mo4077A1();
                return;
            }
            return;
        }
        this.f11026B.add(new RunnableC3302d(i));
    }
    ...
    public void mo4086G0(View view, int i, int i2) {
        ...
        int width = recyclerView != null ? recyclerView.getWidth() : this.f11033I;
        RecyclerView recyclerView2 = this.f11028D;
        view.measure(RecyclerView.AbstractC0669o.m3732O(width, mo4127i0() + mo4129j0() + ((ViewGroup.MarginLayoutParams) pVar).leftMargin + ((ViewGroup.MarginLayoutParams) pVar).rightMargin + i3, ((ViewGroup.MarginLayoutParams) pVar).width, false), RecyclerView.AbstractC0669o.m3732O(recyclerView2 != null ? recyclerView2.getHeight() : this.f11034J, mo4131k0() + mo4124h0() + ((ViewGroup.MarginLayoutParams) pVar).topMargin + ((ViewGroup.MarginLayoutParams) pVar).bottomMargin + i4, ((ViewGroup.MarginLayoutParams) pVar).height, false));
    }
    ...
    public void mo3385Q1(RecyclerView recyclerView, RecyclerView.C0649a0 a0Var, int i) {
        ...
        int i2 = this.f11029E;
        if (i2 == 0 && c0 > 0) {
            this.f11026B.add(new RunnableC3303e(recyclerView, a0Var, i));
        } else if (i2 * c0 != 0) {
            ...
            for (int i4 = -1; i4 <= 1; i4++) {
                if (mo11178l2() || i4 == 0) {
                    int i5 = this.f11029E;
                    int i6 = (((i4 * c0) + max) * i5) - (this.f11037M % (i5 * c0));
    ...
    public void mo11170W1(RecyclerView.C0681v vVar, RecyclerView.C0649a0 a0Var, int i, int i2) {
        ...
        this.f11034J = 0;
        m13820p2(vVar);
        int max = Math.max(this.f11029E, mo4122g0());
        int max2 = Math.max(this.f11030F, mo4121f0());
    ...
    public void mo8437Y1(RecyclerView.C0681v vVar, RecyclerView.C0649a0 a0Var) {
        ...
        int d2 = mo11172d2();
        if (h2 <= i22) {
            int i3 = C3304f.f11057a[this.f11043y.ordinal()];
            if (i3 == 1 || i3 == 2) {
                if (this.f11043y == C1546a.EnumC1552f.FirstFront) {
                    i = -1;
                    i22 = h2;
                    h2 = i22;
                } else {
    ...
    public float mo11171c2() {
        float q2 = mo11180q2(this.f11037M);
    ...
    public void mo3430d1(RecyclerView.C0681v vVar, RecyclerView.C0649a0 a0Var) {
        ...
        m13820p2(vVar);
        m13809C2();
        if (a0Var.mo3944b() || this.f11035K || this.f11036L) {
            mo4153x(vVar);
            this.f11035K = false;
            this.f11036L = false;
        }
    ...
    public int mo11172d2() {
        return Math.round(mo11180q2(this.f11037M));
    }

    /* renamed from: e2 */
    public float mo11173e2() {
        return mo11180q2(this.f11037M);
    }
    ...
    public void mo3437f1(RecyclerView.C0681v vVar, RecyclerView.C0649a0 a0Var, int i, int i2) {
        ...
        m13818n2("carousel width = " + this.f11033I + ", height = " + this.f11034J, new Object[0]);
        if (C1546a.m7570O1()) {
            int mode = View.MeasureSpec.getMode(i);
            int mode2 = View.MeasureSpec.getMode(i2);
            int size = View.MeasureSpec.getSize(i);
            int size2 = View.MeasureSpec.getSize(i2);
            Log.d(f11022s, String.format("carousel onMeasure %d %d %d %d", Integer.valueOf(mode), Integer.valueOf(mode2), Integer.valueOf(size), Integer.valueOf(size2)));
        }
    }
    ...
    public void mo3445i1(Parcelable parcelable) {
        ...
        if (parcelable instanceof C3305g) {
            this.f11037M = ((C3305g) parcelable).f11058b;
        }
    }
