...
public class C2841x {
    ...
    public class C2842a implements Comparator<C2846e> {
        ...
        public int compare(C2846e eVar, C2846e eVar2) {
            return eVar2.f9602a.length() - eVar.f9602a.length();
        }
    }
    ...
    public class AsyncTaskC2844c extends AsyncTask<Object, Void, Boolean> {
        ...
        public Boolean doInBackground(Object... objArr) {
            ...
            this.f9600c = (String) objArr[1];
            this.f9599b = (AbstractC2845d) objArr[2];
            return !C2841x.this.m11838m(activity) ? Boolean.FALSE : !C2841x.this.mo9423h(this.f9598a) ? Boolean.FALSE : Boolean.TRUE;
        }
        ...
        public void onPostExecute(Boolean bool) {
            Activity activity;
            if (bool.booleanValue() && (activity = this.f9598a) != null && !activity.isFinishing()) {
                C2841x.this.mo9421c(this.f9600c, this.f9599b);
            }
        }
    }
    ...
    private int m11833e(Matcher matcher, int i, C2369h0 h0Var) {
        ...
        if (matcher.group(i) != null) {
            h0Var.f8311k = matcher.group(i).trim();
        }
        int i2 = i + 1;
        if (matcher.group(i2) != null) {
            h0Var.f8301a = mo9426o(Integer.parseInt(matcher.group(i2)));
            h0Var.f8302b = 0;
        } else {
            int i3 = i + 2;
            if (matcher.group(i3) != null) {
                ...
                i3 = i + 3;
                if (matcher.group(i3) != null) {
                    h0Var.f8301a = mo9426o(Integer.parseInt(matcher.group(i3)));
                } else {
                    int i4 = i + 4;
                    if (matcher.group(i4) != null) {
                        int i5 = i + 5;
                        if (matcher.group(i5) != null) {
                            h0Var.f8301a = mo9426o(Integer.parseInt(matcher.group(i4)));
                            group = matcher.group(i5);
                            h0Var.f8302b = mo9426o(Integer.parseInt(group) + 1);
                        }
                    }
                }
            }
        ...
        if (matcher.group(i6) != null) {
            h0Var.f8311k = matcher.group(i6).trim();
        }
        return i + 7;
    }
    ...
    private int m11835g(String str) {
        ...
        for (int i = 0; i < size; i++) {
            C2843b bVar = this.f9593e.get(i);
            if (str.equals(bVar.f9595a)) {
                return bVar.f9596b;
            }
        }
        return -1;
    ...
    private void m11837l(C2369h0 h0Var, String str) {
        for (int i = 0; i < this.f9592d.length; i++) {
            if (Pattern.compile("^" + this.f9592d[i].f9602a + "$").matcher(str).find()) {
                h0Var.f8308h = this.f9592d[i].f9603b;
            }
        }
        h0Var.f8309i = "";
        h0Var.f8310j = -1;
    ...
    private boolean m11838m(Context context) {
        ...
        this.f9592d = new C2846e[rawQuery.getCount()];
        int i = 0;
        do {
            ...
            this.f9592d[i] = new C2846e();
            C2846e[] eVarArr = this.f9592d;
            eVarArr[i].f9602a = p;
            eVarArr[i].f9603b = rawQuery.getString(2);
            i++;
        } while (rawQuery.moveToNext());
        Arrays.sort(this.f9592d, new C2842a());
        rawQuery.close();
        this.f9590b = "(";
        for (int i2 = 0; i2 < this.f9592d.length; i2++) {
            if (i2 > 0) {
                this.f9590b += "|";
            }
            this.f9590b += this.f9592d[i2].f9602a;
        }
        this.f9590b += ")";
        return true;
    }
    ...
    public void mo9421c(String str, AbstractC2845d dVar) {
        ...
        if (str != null) {
            ...
            if (!p.equals("")) {
                ...
                Matcher matcher3 = Pattern.compile("^(?:show (?:me )?)?(all |every |go to )?" + "(my most played|most played|my longest played|longest played|last played|highest rated|best rated)? ?" + "(favou?rites?)? ?" + "(?:" + this.f9591c + "|(.*?))(?: games?)? on (?:the )?" + "(?:((?:2nd|second)|(?:3rd|third)|(?:4th|fourth)|(?:5th|fifth)|(?:6th|sixth)|(?:7th|seventh)|(?:8th|eighth)) generation)? ?" + "(?:" + this.f9590b + "|" + "(computers?|consoles?|arcade|hand ?helds?)(?: systems?| devices?)?" + ")(?: " + str2 + ")?(?:" + str3 + ")?$").matcher(p);
                if (matcher3.find()) {
                    ...
                    if (matcher3.group(4) != null) {
                        filter.f8303c = m11835g(matcher3.group(4));
                        filter.f8312l = matcher3.group(4).substring(0, i).toUpperCase() + matcher3.group(4).substring(i);
                    }
                    if (matcher3.group(5) != null && !matcher3.group(5).trim().equals("")) {
                        filter.f8307g = matcher3.group(5).trim();
                    }
                ...
                if (matcher4.find()) {
                    ...
                    if (matcher4.group(7) != null) {
                        filter.f8303c = m11835g(matcher4.group(7));
                        filter.f8312l = matcher4.group(7).substring(0, 1).toUpperCase() + matcher4.group(7).substring(1);
                    }
                    if (matcher4.group(8) != null && !matcher4.group(8).trim().equals("")) {
                        filter.f8307g = matcher4.group(8).trim();
                    }
                    int e2 = m11833e(matcher4, 9, filter);
                    if (matcher4.group(e2) != null) {
                        filter.f8314n = mo9425k(matcher4.group(e2));
                        filter.f8315o = mo9422d(matcher4.group(e2));
                    }
                    dVar.mo8929d(filter);
                    return;
                }
                Matcher matcher5 = Pattern.compile("^(?:show (?:me )?)?(all |every |go to )?" + "(my most played|most played|my longest played|longest played|last played|highest rated|best rated)? ?" + "(favou?rites?)? ?" + "(?:((?:2nd|second)|(?:3rd|third)|(?:4th|fourth)|(?:5th|fifth)|(?:6th|sixth)|(?:7th|seventh)|(?:8th|eighth)) generation)? ?" + "(?:" + this.f9591c + "|" + "(computers?|consoles?|arcade|hand ?helds?)(?: systems?| devices?)?" + "|" + this.f9590b + "|(.*?)) ?(?:games?)? ?(?:" + str2 + ")?(?:" + str3 + ")?$").matcher(p);
                if (matcher5.find()) {
                    ...
                    if (matcher5.group(5) != null) {
                        filter.f8303c = m11835g(matcher5.group(5));
                        filter.f8312l = matcher5.group(5).substring(0, 1).toUpperCase() + matcher5.group(5).substring(1);
                    }
                    ...
                    if (matcher5.group(8) != null && !matcher5.group(8).trim().equals("")) {
                        filter.f8307g = matcher5.group(8).trim();
                    }
                    int e3 = m11833e(matcher5, 9, filter);
                    if (matcher5.group(e3) != null) {
                        filter.f8314n = mo9425k(matcher5.group(e3));
                        filter.f8315o = mo9422d(matcher5.group(e3));
                    }
                    dVar.mo8929d(filter);
                }
            }
    ...
    public boolean mo9423h(Context context) {
        ...
        do {
            ...
            if (split.length > 1) {
                ...
                bVar.f9595a = mo9427p(rawQuery.getString(1));
                bVar.f9596b = rawQuery.getInt(0);
                this.f9593e.add(bVar);
            }
            for (String str : split) {
                C2843b bVar2 = new C2843b();
                bVar2.f9595a = mo9427p(str);
                bVar2.f9596b = rawQuery.getInt(0);
                this.f9593e.add(bVar2);
            }
        } while (rawQuery.moveToNext());
        rawQuery.close();
        this.f9591c = "(";
        for (int i = 0; i < this.f9593e.size(); i++) {
            if (i > 0) {
                this.f9591c += "|";
            }
            this.f9591c += this.f9593e.get(i).f9595a;
        }
        this.f9591c += ")";
        return true;
    }
    ...
    public void mo9424j(C2369h0 h0Var, String str) {
        h0Var.f8314n = mo9425k(str);
        h0Var.f8315o = mo9422d(str);
    }
