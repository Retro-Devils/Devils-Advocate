...
public class C2848x1 {
    ...
    public class DialogInterface$OnClickListenerC2849a implements DialogInterface.OnClickListener {
        ...
        /* renamed from: b */
        final /* synthetic */ ArrayList f9623b;
        ...
        /* renamed from: e */
        final /* synthetic */ AbstractC2851c f9626e;
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            C2848x1.this.mo9436b((String[]) this.f9623b.get(i), this.f9624c, this.f9625d, this.f9626e);
        }
    }
    ...
    public class AsyncTaskC2850b extends AsyncTask<Void, Void, Integer> {
        ...
        /* renamed from: c */
        final /* synthetic */ AbstractC2851c f9630c;
        ...
        public Integer doInBackground(Void... voidArr) {
            int e;
            if (!C2848x1.this.mo9441g(this.f9628a)) {
                e = 0;
            } else {
                C2848x1 x1Var = C2848x1.this;
                e = x1Var.f9620k ? x1Var.mo9439e(this.f9628a, this.f9629b) : x1Var.mo9440f(this.f9628a, this.f9629b);
            }
        ...
        public void onPostExecute(Integer num) {
            ...
            if (intValue == 0) {
                ...
                this.f9630c.mo8083e(C2848x1.this.f9621l);
            } else if (intValue == 3) {
                AbstractC2851c cVar = this.f9630c;
                C2848x1 x1Var = C2848x1.this;
                cVar.mo8079a(x1Var.f9622m, x1Var.f9621l);
            }
        }
    }
    ...
    public void mo9435a(String str, String str2, String str3, AbstractC2851c cVar) {
        ...
        if (this.f9615f != null) {
            ...
            if (arrayList.size() == 0) {
                ...
                new DialogInterfaceC0068b.C0069a(this.f9615f, C2553q3.m11117c()).mo238r(R.string.select_model).mo227g(charSequenceArr, new DialogInterface$OnClickListenerC2849a(arrayList, str, str3, cVar)).mo221a().show();
            }
        }
    }
    ...
    public void mo9436b(String[] strArr, String str, String str2, AbstractC2851c cVar) {
        this.f9618i = strArr[1];
        this.f9619j = strArr[2];
        this.f9620k = strArr[3].equals("chd");
    ...
    public boolean mo9437c(String str, String str2) {
        try {
            C2399i2 i2Var = new C2399i2(C2399i2.m10374d(this.f9615f, str), str2);
            if (i2Var.exists()) {
                return true;
            }
            AssetManager assets = this.f9615f.getAssets();
    ...
    public void mo9438d(String str, SQLiteDatabase sQLiteDatabase) {
        ...
        if (rawQuery.moveToFirst()) {
            do {
                ...
                Cursor rawQuery2 = C2775u.m11726e(this.f9615f).mo9325c().rawQuery("SELECT r.filename,p.path,p.uri FROM roms as r,rompaths as p WHERE r.mdbid=" + j + " AND r.present=1 AND p._id=r.pathid", null);
                if (rawQuery2.moveToFirst()) {
                    boolean z = false;
                    do {
                        String string = rawQuery2.getString(0);
                        C2399i2 i2Var = new C2399i2(C2399i2.m10374d(this.f9615f, rawQuery2.isNull(2) ? rawQuery2.getString(1) : rawQuery2.getString(2)), string);
                        String absolutePath = i2Var.getAbsolutePath();
                        if (C2363g4.m10276c(absolutePath) && i2Var.exists()) {
                            C2363g4 g4Var = new C2363g4(this.f9615f, absolutePath);
                            while (true) {
                                C2363g4.C2364a d = g4Var.mo8020d();
                                if (d == null || z) {
                                    break;
                                }
                                Cursor rawQuery3 = sQLiteDatabase.rawQuery("SELECT rowid FROM mess WHERE rowid=" + d.f8286c + " AND slug='" + this.f9619j + "'", null);
                                if (rawQuery3.moveToFirst()) {
                                    String str2 = this.f9619j;
                                    if (string.lastIndexOf(46) > 0) {
                                        str2 = str2 + string.substring(string.lastIndexOf(46));
                                    }
                                    String absolutePath2 = new C2399i2(C2399i2.m10374d(this.f9615f, this.f9617h), str2).getAbsolutePath();
                                    if (!absolutePath.equalsIgnoreCase(absolutePath2)) {
                                        C2185a4.m9672b(this.f9615f, absolutePath, absolutePath2);
                                        z = true;
                                    }
                                }
                                rawQuery3.close();
    ...
    public int mo9439e(String str, String str2) {
        C2886z1 b = C2886z1.m11967b(this.f9615f);
        b.mo9516c();
        ...
        if (file.getName().toLowerCase().equals(string2.toLowerCase() + ".chd")) {
            ...
            if (parentFile.getName().toLowerCase().equals(string)) {
                ...
                if (parentFile2.getName().toLowerCase().equals(this.f9619j)) {
                    ...
                    if (file2.exists()) {
                        this.f9617h = parentFile2.getAbsolutePath();
                        str3 = str4;
                    }
                }
            }
        ...
        if (str3 == null) {
            File file3 = new File(this.f9617h + "/" + string);
            if (!file3.exists()) {
                try {
                    file3.mkdirs();
        ...
        mo9438d(str, a);
        this.f9621l = str3;
        this.f9622m = this.f9617h + "/" + string + "/" + string2 + ".chd";
        return new File(this.f9622m).exists() ? 2 : 3;
    }
    ...
    public int mo9440f(String str, String str2) {
        ...
        if (C2363g4.m10276c(str2)) {
            try {
                g4Var = new C2363g4(this.f9615f, str2);
                str3 = null;
                while (true) {
                    try {
                        C2363g4.C2364a d = g4Var.mo8020d();
                        if (d == null || str3 != null) {
                            ...
                            Cursor rawQuery = a.rawQuery("SELECT slug FROM mess WHERE rowid=" + d.f8286c, null);
                            if (rawQuery.moveToFirst()) {
    ...
    public boolean mo9441g(String str) {
        ...
        if (Build.VERSION.SDK_INT < 30) {
            str2 = new C2882y2(this.f9615f).mo8772i("system_directory");
        } else {
            str2 = new C2399i2(C2399i2.m10374d(this.f9615f, C2219c3.m9805k(this.f9615f).mo8193q("retroarch_dir", null)), "system").getAbsolutePath();
        }
        if (str2.equals("")) {
            return false;
        }
        this.f9616g = new C2399i2(C2399i2.m10374d(this.f9615f, str2), this.f9616g).getAbsolutePath();
        String absolutePath = new C2399i2(C2399i2.m10374d(this.f9615f, this.f9616g), "hash").getAbsolutePath();
        C2399i2 d = C2399i2.m10374d(this.f9615f, absolutePath);
        if (!d.exists()) {
            try {
                d.mkdirs();
            } catch (Exception unused) {
        ...
        if (!mo9437c(absolutePath, this.f9618i)) {
            return false;
        }
        ...
        C2399i2 d2 = C2399i2.m10374d(this.f9615f, this.f9616g);
        C2399i2 i2Var = new C2399i2(d2, "/roms/" + this.f9619j);
        if (!i2Var.exists()) {
            try {
                i2Var.mkdirs();
            } catch (Exception unused2) {
        ...
        this.f9617h = i2Var.getAbsolutePath();
        return true;
    }
}
