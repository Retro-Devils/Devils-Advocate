...
class C2826w0 extends AbstractC2208b4 {
    ...
    public void mo3581j(RecyclerView.AbstractC0655d0 d0Var, int i) {
        ...
        if (d0Var != null) {
            ...
            this.f9558l.mo8960b(x0Var.f9605u, x0Var.f9606v, x0Var.f9607w, x0Var.f9608x, x0Var.f9609y, i);
        }
    }
    ...
    public RecyclerView.AbstractC0655d0 mo3582l(ViewGroup viewGroup, int i) {
        return this.f9558l.mo8967i(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.carousel_view, viewGroup, false), (float) this.f8291f);
    }
}
