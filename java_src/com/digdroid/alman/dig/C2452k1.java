...
public class C2452k1 extends AbstractC2303f0 {
    ...
    public void mo8417D3(String str) {
        ...
        if (!rawQuery.moveToFirst()) {
            ...
            this.f8165x0.insert("genres", null, contentValues);
    ...
    public boolean mo8421H3() {
        return this.f8801Z.mo8180c("show_all_genres", true);
    }
    ...
    public Cursor mo8694k3() {
        ...
        Cursor rawQuery = this.f8165x0.rawQuery(str2 + " ORDER BY name", null);
        mo8434z3(rawQuery);
        return rawQuery;
    }
    ...
    public void mo8439p2(Menu menu) {
        super.mo8439p2(menu);
        menu.findItem(R.id.hide_genres).setChecked(!this.f8166y0);
    }
