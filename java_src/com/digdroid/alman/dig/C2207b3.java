...
public class C2207b3 extends C2492n {
    ...
    /* renamed from: f */
    SQLiteDatabase f7921f;

    /* renamed from: g */
    SQLiteDatabase f7922g;

    C2207b3(Context context) {
        super(context);
        this.f7922g = C2775u.m11726e(context).mo9325c();
        C2886z1 b = C2886z1.m11967b(context);
        b.mo9516c();
        this.f7921f = b.mo9515a();
        mo8783t(false);
    }

    /* renamed from: A */
    public void mo8095A(String str, long j) {
        int indexOf = this.f8640b.indexOf(91, 10);
        if (indexOf > 0) {
            this.f8640b = this.f8640b.substring(0, indexOf);
        }
        String x = mo8099x(j);
        if (x != null) {
            ...
            this.f8640b += "[" + x + "]\n";
            this.f8640b += "\ngameid=" + x + "\n";
            Cursor rawQuery = this.f7921f.rawQuery("SELECT title FROM titles WHERE rowid=" + mo8098w(j), null);
            rawQuery.moveToFirst();
            this.f8640b += "description=" + rawQuery.getString(0) + "\n";
            rawQuery.close();
            this.f8640b += "path=" + str + "\n";
        }
    }
    ...
    public String mo8097v() {
        return new C2399i2(C2399i2.m10374d(this.f8639a, mo8096u()), ".config/scummvm/scummvm.ini").getAbsolutePath();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: w */
    public long mo8098w(long j) {
        SQLiteDatabase sQLiteDatabase = this.f7922g;
    ...
    public String mo8099x(long j) {
        ...
        String str = null;
        if (w >= 0) {
            SQLiteDatabase sQLiteDatabase = this.f7921f;
    ...
    /* renamed from: y */
    public void mo8100y() {
        mo8774k(C2399i2.m10374d(this.f8639a, mo8097v()));
    }

    /* renamed from: z */
    public boolean mo8101z() {
        C2399i2 d = C2399i2.m10374d(this.f8639a, mo8096u());
        if (!d.exists()) {
            try {
                d.mkdirs();
