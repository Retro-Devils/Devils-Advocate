...
class C2222d extends AbstractC2526p {
    ...
    /* renamed from: e */
    SQLiteDatabase f7966e;

    /* renamed from: f */
    SQLiteDatabase f7967f;

    public C2222d(SQLiteDatabase sQLiteDatabase, SQLiteDatabase sQLiteDatabase2) {
        this.f7967f = sQLiteDatabase;
        this.f7966e = sQLiteDatabase2;
    }
    ...
    public String mo8092c(int i, String str, long j, long j2, String str2) {
        SQLiteDatabase sQLiteDatabase = this.f7966e;
        ...
        rawQuery.close();
        SQLiteDatabase sQLiteDatabase2 = this.f7967f;
