...
public class C2465m0 {
    ...
    /* renamed from: c */
    SQLiteDatabase f8602c;

    /* renamed from: d */
    AbstractC2488p f8603d;

    /* renamed from: e */
    AbstractC2531p1.AbstractC2532a f8604e;
    ...
    public class DialogInterface$OnClickListenerC2466a implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            SQLiteDatabase sQLiteDatabase = C2465m0.this.f8602c;
            sQLiteDatabase.update("roms", contentValues, "_id=" + C2465m0.this.f8601b, null);
            C2369h0 filter = C2465m0.this.f8603d.getFilter();
            Activity activity = C2465m0.this.f8600a;
            if (C2512o0.m10833g(activity, C2775u.m11726e(activity)).mo8848m(filter)) {
                ...
                SQLiteDatabase sQLiteDatabase2 = C2465m0.this.f8602c;
                sQLiteDatabase2.update("roms", contentValues2, "merged_with=" + C2465m0.this.f8601b, null);
            }
            C2465m0.this.f8603d.mo8664b();
        }
    }
    ...
    public class DialogInterface$OnClickListenerC2468c implements DialogInterface.OnClickListener {
        ...
        /* renamed from: b */
        final /* synthetic */ SQLiteDatabase f8608b;
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            SQLiteDatabase sQLiteDatabase = this.f8608b;
            sQLiteDatabase.execSQL("DELETE FROM gamegenres WHERE game=" + C2465m0.this.f8601b);
            for (int i2 = 0; i2 < this.f8609c; i2++) {
                if (this.f8610d[i2]) {
                    ContentValues contentValues = new ContentValues();
                    contentValues.put("game", Long.valueOf(C2465m0.this.f8601b));
                    contentValues.put("genre", Long.valueOf(this.f8611e[i2]));
                    this.f8608b.insert("gamegenres", null, contentValues);
                }
            }
            C2465m0.this.f8603d.mo8664b();
        }
    ...
    public class DialogInterface$OnClickListenerC2469d implements DialogInterface.OnClickListener {
        ...
        class DialogInterface$OnClickListenerC2470a implements DialogInterface.OnClickListener {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                SQLiteDatabase sQLiteDatabase = C2465m0.this.f8602c;
                sQLiteDatabase.execSQL("DELETE FROM gamecollection WHERE _id=" + DialogInterface$OnClickListenerC2469d.this.f8613b[this.f8615b]);
                C2465m0.this.f8603d.mo8664b();
            }
        }
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            new DialogInterfaceC0068b.C0069a(C2465m0.this.f8600a, C2553q3.m11117c()).mo228h(R.string.confirm).mo232l(R.string.cancel, null).mo235o(R.string.ok, new DialogInterface$OnClickListenerC2470a(i)).mo221a().show();
        }
    }
    ...
    public class DialogInterface$OnClickListenerC2471e implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (trim != null && !trim.equals("")) {
                SQLiteDatabase c = C2775u.m11726e(this.f8618c).mo9325c();
    ...
    public class DialogInterface$OnClickListenerC2472f implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            SQLiteDatabase sQLiteDatabase = C2465m0.this.f8602c;
            sQLiteDatabase.execSQL("UPDATE roms SET youtube=NULL WHERE _id=" + C2465m0.this.f8601b);
            C2465m0.this.f8603d.mo8664b();
        }
    }
    ...
    public class DialogInterface$OnClickListenerC2473g implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            SQLiteDatabase sQLiteDatabase = C2465m0.this.f8602c;
            Cursor rawQuery = sQLiteDatabase.rawQuery("SELECT mdbid FROM roms WHERE _id=" + C2465m0.this.f8601b, null);
            if (rawQuery.moveToFirst()) {
                long j = rawQuery.getLong(0);
                if (j >= 0) {
                    SQLiteDatabase a = C2886z1.m11967b(C2465m0.this.f8600a).mo9515a();
                    ...
                    if (rawQuery2.moveToFirst()) {
                        ...
                        if (j2 != 0) {
                            ...
                            SQLiteDatabase sQLiteDatabase2 = C2465m0.this.f8602c;
                            sQLiteDatabase2.update("roms", contentValues, "_id=" + C2465m0.this.f8601b, null);
                            C2465m0.this.f8603d.mo8664b();
                        }
                        contentValues.put("youtube", (String) null);
                        SQLiteDatabase sQLiteDatabase22 = C2465m0.this.f8602c;
                        sQLiteDatabase22.update("roms", contentValues, "_id=" + C2465m0.this.f8601b, null);
                        C2465m0.this.f8603d.mo8664b();
                    }
                    rawQuery2.close();
                }
    ...
    public class C2475i implements C2223d0.AbstractC2249s {
        ...
        public void mo7941a() {
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                MyWidget.m9545a(m0Var.f8600a, m0Var.f8601b, false);
            }
        }
    ...
    public class C2477k implements C2223d0.AbstractC2249s {
        ...
        class DialogInterface$OnClickListenerC2478a implements DialogInterface.OnClickListener {
            ...
            class C2479a implements AbstractC2487o {
                ...
                public void mo8739a(long j) {
                    SQLiteDatabase sQLiteDatabase = C2465m0.this.f8602c;
                    Cursor rawQuery = sQLiteDatabase.rawQuery("SELECT _id FROM gamecollection WHERE collection=" + j + " AND game=" + C2465m0.this.f8601b, null);
                    if (!rawQuery.moveToFirst()) {
                        ContentValues contentValues = new ContentValues();
                        contentValues.put("collection", Long.valueOf(j));
                        contentValues.put("game", Long.valueOf(C2465m0.this.f8601b));
                        C2465m0.this.f8602c.insert("gamecollection", null, contentValues);
                        C2465m0.this.f8603d.mo8664b();
                    }
                    rawQuery.close();
                }
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                C2465m0.m10622b(C2465m0.this.f8600a, this.f8626b[i], new C2479a());
            }
        }
        ...
        /* renamed from: a */
        public void mo7941a() {
            Cursor rawQuery = C2465m0.this.f8602c.rawQuery("SELECT _id,name FROM collections WHERE isfolder=0 ORDER BY name", null);
            int count = rawQuery.moveToFirst() ? rawQuery.getCount() : 0;
            int i = count + 1;
            CharSequence[] charSequenceArr = new CharSequence[i];
            long[] jArr = new long[i];
            charSequenceArr[0] = C2465m0.this.f8600a.getString(R.string.new_collection);
            jArr[0] = -1;
            int i2 = 0;
            while (i2 < count) {
                i2++;
            ...
            rawQuery.close();
            new DialogInterfaceC0068b.C0069a(C2465m0.this.f8600a, C2553q3.m11117c()).mo238r(R.string.add_to_collection).mo227g(charSequenceArr, new DialogInterface$OnClickListenerC2478a(jArr)).mo221a().show();
        }
    ...
    public class C2480l implements C2223d0.AbstractC2249s {
        ...
        class DialogInterface$OnClickListenerC2481a implements DialogInterface.OnClickListener {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                SQLiteDatabase sQLiteDatabase = C2465m0.this.f8602c;
                sQLiteDatabase.execSQL("UPDATE roms SET ignored=1 WHERE _id=" + C2465m0.this.f8601b);
                Activity activity = C2465m0.this.f8600a;
                C2512o0.m10833g(activity, C2775u.m11726e(activity)).mo8852t(C2465m0.this.f8601b);
                C2465m0.this.f8603d.mo8663a();
            }
        }
        ...
        public void mo7941a() {
            Activity activity = C2465m0.this.f8600a;
            if (activity != null && !activity.isFinishing()) {
                new DialogInterfaceC0068b.C0069a(C2465m0.this.f8600a, C2553q3.m11117c()).mo229i(C2465m0.this.f8600a.getString(R.string.confirm_ignore)).mo232l(17039360, new DialogInterface$OnClickListenerC2482b()).mo235o(17039370, new DialogInterface$OnClickListenerC2481a()).mo221a().show();
            }
        }
    ...
    public class C2483m implements C2223d0.AbstractC2249s {
        ...
        public void mo7941a() {
            Activity activity = C2465m0.this.f8600a;
            if (activity != null && !activity.isFinishing()) {
                new DialogInterfaceC0068b.C0069a(C2465m0.this.f8600a, C2553q3.m11117c()).mo228h(R.string.confirm_delete).mo232l(R.string.cancel, null).mo235o(R.string.ok, new DialogInterface$OnClickListenerC2484a()).mo221a().show();
            }
        }
    ...
    public class DialogInterface$OnClickListenerC2486n implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            String trim = this.f8636b.getText().toString().trim();
            if (trim != null && !trim.equals("")) {
                SQLiteDatabase sQLiteDatabase = C2465m0.this.f8602c;
                sQLiteDatabase.execSQL("UPDATE roms SET sortname=" + DatabaseUtils.sqlEscapeString(trim) + " WHERE _id=" + C2465m0.this.f8601b);
                C2465m0.this.f8603d.mo8664b();
            }
        }
    }
    ...
    public C2465m0(Activity activity, long j, AbstractC2488p pVar, AbstractC2531p1.AbstractC2532a aVar) {
        ...
        this.f8603d = pVar;
        this.f8604e = aVar;
        this.f8602c = C2775u.m11726e(activity).mo9325c();
    }
    ...
    private void m10623d() {
        SQLiteDatabase sQLiteDatabase = this.f8602c;
        Cursor rawQuery = sQLiteDatabase.rawQuery("SELECT gc._id,c.name FROM gamecollection as gc,collections as c WHERE gc.game=" + this.f8601b + " AND c._id=gc.collection ORDER BY c.name", null);
        if (!rawQuery.moveToFirst()) {
            rawQuery.close();
            return;
        }
        ...
        rawQuery.close();
        new DialogInterfaceC0068b.C0069a(this.f8600a, C2553q3.m11117c()).mo238r(R.string.remove_collection).mo227g(charSequenceArr, new DialogInterface$OnClickListenerC2469d(jArr)).mo221a().show();
    }
    ...
    public void mo8728a() {
        ...
        if (rawQuery.moveToFirst()) {
            ...
            do {
                ...
                zArr[i] = false;
                Cursor rawQuery2 = sQLiteDatabase.rawQuery("SELECT * FROM gamegenres WHERE game=" + this.f8601b + " AND genre=" + jArr[i], null);
                if (rawQuery2.moveToFirst()) {
                    zArr[i] = true;
                }
                rawQuery2.close();
        ...
        rawQuery.close();
        DialogInterfaceC0068b.C0069a aVar = new DialogInterfaceC0068b.C0069a(this.f8600a, C2553q3.m11117c());
    ...
    public boolean mo8729c(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.add_collection /*{ENCODED_INT: 2131296340}*/:
                C2223d0.m9876p().mo8215r(this.f8600a, 16, new C2477k());
                return true;
            case R.id.add_homescreen /*{ENCODED_INT: 2131296342}*/:
                C2223d0.m9876p().mo8215r(this.f8600a, 2, new C2475i());
                return true;
            case R.id.delete /*{ENCODED_INT: 2131296578}*/:
                C2223d0.m9876p().mo8215r(this.f8600a, 13, new C2483m());
                return true;
            case R.id.delete_video /*{ENCODED_INT: 2131296581}*/:
                new DialogInterfaceC0068b.C0069a(this.f8600a, C2553q3.m11117c()).mo228h(R.string.confirm).mo232l(R.string.cancel, null).mo235o(R.string.ok, new DialogInterface$OnClickListenerC2472f()).mo221a().show();
                return true;
            case R.id.edit_genres /*{ENCODED_INT: 2131296635}*/:
                C2223d0.m9876p().mo8215r(this.f8600a, 5, new C2476j());
                return true;
            case R.id.edit_sort /*{ENCODED_INT: 2131296638}*/:
                SQLiteDatabase sQLiteDatabase = this.f8602c;
                Cursor rawQuery = sQLiteDatabase.rawQuery("SELECT  sortname FROM roms WHERE _id=" + this.f8601b, null);
                if (rawQuery.moveToFirst()) {
                    String string = rawQuery.getString(0);
                    View inflate = this.f8600a.getLayoutInflater().inflate(R.layout.genre_edit, (ViewGroup) null);
                    EditText editText = (EditText) inflate.findViewById(R.id.genre_input);
                    editText.setText(string);
                    editText.setTextColor(C2553q3.m11116b());
                    new DialogInterfaceC0068b.C0069a(this.f8600a, C2553q3.m11117c()).mo240t(inflate).mo228h(R.string.edit_sort).mo232l(17039360, null).mo235o(17039370, new DialogInterface$OnClickListenerC2486n(editText)).mo221a().show();
                }
                return true;
            case R.id.favorite /*{ENCODED_INT: 2131296659}*/:
                SQLiteDatabase sQLiteDatabase2 = this.f8602c;
                Cursor rawQuery2 = sQLiteDatabase2.rawQuery("SELECT favorite FROM roms WHERE _id=" + this.f8601b, null);
                if (rawQuery2.moveToFirst()) {
                    ...
                    SQLiteDatabase sQLiteDatabase3 = this.f8602c;
                    sQLiteDatabase3.update("roms", contentValues, "_id=" + this.f8601b, null);
                    this.f8603d.mo8665c(z);
                }
                rawQuery2.close();
                return true;
            case R.id.ignore /*{ENCODED_INT: 2131296788}*/:
                C2223d0.m9876p().mo8215r(this.f8600a, 12, new C2480l());
                return true;
            case R.id.rate /*{ENCODED_INT: 2131297063}*/:
                new C2828w2(this.f8600a, this.f8602c, false, new C2474h()).mo9396f(this.f8601b);
                return true;
            case R.id.remove_collection /*{ENCODED_INT: 2131297073}*/:
                m10623d();
                return true;
            case R.id.reset_stats /*{ENCODED_INT: 2131297077}*/:
                new DialogInterfaceC0068b.C0069a(this.f8600a, C2553q3.m11117c()).mo228h(R.string.confirm).mo232l(R.string.cancel, null).mo235o(R.string.ok, new DialogInterface$OnClickListenerC2466a()).mo221a().show();
                return true;
            case R.id.reset_video /*{ENCODED_INT: 2131297078}*/:
                new DialogInterfaceC0068b.C0069a(this.f8600a, C2553q3.m11117c()).mo228h(R.string.confirm).mo232l(R.string.cancel, null).mo235o(R.string.ok, new DialogInterface$OnClickListenerC2473g()).mo221a().show();
                return true;
            case R.id.search_video /*{ENCODED_INT: 2131297131}*/:
                this.f8604e.mo8253A(this.f8601b);
                return true;
            default:
                return false;
        }
