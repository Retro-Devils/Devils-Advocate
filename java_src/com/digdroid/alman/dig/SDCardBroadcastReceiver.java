    ...
    class AsyncTaskC2129a extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... voidArr) {
            try {
                ...
                if (context != null && !C2185a4.m9694x(context) && !C2185a4.m9692v(this.f7697a)) {
                    Intent intent = this.f7698b;
                    if (intent != null) {
                        ...
                        if ("android.intent.action.MEDIA_MOUNTED".equals(action) || "android.intent.action.MEDIA_EJECT".equals(action) || "android.intent.action.MEDIA_REMOVED".equals(action) || "android.intent.action.MEDIA_BAD_REMOVAL".equals(action)) {
                            ...
                            C2775u e = C2775u.m11726e(this.f7697a.getApplicationContext());
                            e.mo9329h();
                            SQLiteDatabase c = e.mo9325c();
                            C2219c3 k = C2219c3.m9805k(this.f7697a.getApplicationContext());
                            C2375h3 r = C2375h3.m10306r(this.f7697a.getApplicationContext(), e);
                            r.mo8543C();
                            String replaceAll = this.f7697a.getExternalFilesDir(null).getAbsolutePath().replaceAll("Android.*$", "");
                            ...
                            if ("android.intent.action.MEDIA_MOUNTED".equals(action) && elapsedRealtime > 60000 && k.mo8180c("auto_scan", true)) {
                                ...
                                DatabaseService.m9478v(this.f7697a.getApplicationContext(), "find_dirs");
                                DatabaseService.m9478v(this.f7697a.getApplicationContext(), "scan_dirs");
                                DatabaseService.m9478v(this.f7697a.getApplicationContext(), "merge_games");
                            }
                        }
                        return null;
                    }
