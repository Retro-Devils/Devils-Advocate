...
public class C2219c3 {
    ...
    /* renamed from: a */
    private static C2219c3 f7946a;

    /* renamed from: b */
    private SharedPreferences f7947b;
    ...
    /* renamed from: j */
    public String f7955j = "default";

    /* renamed from: k */
    private Context f7956k;

    private C2219c3(Context context) {
        this.f7956k = context;
        this.f7947b = PreferenceManager.getDefaultSharedPreferences(context);
        this.f7953h = mo8190n("read_announcement", 0) < mo8190n("last_announcement", 0);
        this.f7954i = mo8180c("kiosk_mode", false);
    }
    ...
    public static synchronized C2219c3 m9805k(Context context) {
        ...
        synchronized (C2219c3.class) {
            if (f7946a == null) {
                f7946a = new C2219c3(context.getApplicationContext());
            }
            c3Var = f7946a;
        }
        return c3Var;
    ...
    public void mo8153B(String str, boolean z) {
        SharedPreferences.Editor edit = this.f7947b.edit();
    ...
    public void mo8161J(String str) {
        ...
        this.f7953h = mo8190n("read_announcement", 0) < t;
    }
    ...
    public boolean mo8177Z() {
        File[] b = C2372h2.m10298b(this.f7956k);
        SharedPreferences sharedPreferences = this.f7947b;
        boolean z = true;
    ...
    public boolean mo8178a() {
        return this.f7947b.getBoolean("download_covers", true);
    }

    /* renamed from: b */
    public String mo8179b() {
        return this.f7947b.getString("game_list_type", "grid");
    }

    /* renamed from: c */
    public boolean mo8180c(String str, boolean z) {
        return this.f7947b.getBoolean(str, z);
    }

    /* renamed from: d */
    public long mo8181d() {
        return this.f7947b.getLong("dirs_last_scanned", 0);
    }
    ...
    public float mo8183f(String str, float f) {
        return this.f7947b.getFloat(str, f);
    }

    /* renamed from: g */
    public Long mo8184g() {
        return Long.valueOf(this.f7947b.getLong("game_start_t", 0));
    }
    ...
    public boolean mo8187j() {
        return this.f7947b.getBoolean("inform_scan", true);
    }

    /* renamed from: l */
    public int mo8188l(String str, int i) {
        return this.f7947b.getInt(str, i);
    }

    /* renamed from: m */
    public boolean mo8189m() {
        return this.f7947b.getBoolean("launch_immediately", false);
    }

    /* renamed from: n */
    public long mo8190n(String str, long j) {
        return this.f7947b.getLong(str, j);
    }
    ...
    public boolean mo8192p() {
        return this.f7947b.getBoolean("show_all_systems", false);
    }

    /* renamed from: q */
    public String mo8193q(String str, String str2) {
        return this.f7947b.getString(str, str2);
    }

    /* renamed from: r */
    public Set<String> mo8194r(String str) {
        return this.f7947b.getStringSet(str, new HashSet());
    }

    /* renamed from: s */
    public synchronized boolean mo8195s() {
        return this.f7947b.getBoolean("images_renamed", false);
    }
    ...
    public boolean mo8197u() {
        return ((UiModeManager) this.f7956k.getSystemService("uimode")).getCurrentModeType() == 4;
    }
