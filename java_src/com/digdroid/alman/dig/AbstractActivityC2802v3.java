...
public abstract class AbstractActivityC2802v3 extends AbstractActivityC2260e0 {
    ...
    /* renamed from: b0 */
    static final String[] f9496b0 = {"back", "home", "mainmenu", "voice", "info", "systems", "genres", "collections", "faves", "played", "allgames", "options", "search", "sort", "random", "pagemenu", "mediapause", "mediaplay", "medianext"};

    /* renamed from: c0 */
    static final int[] f9497c0 = {R.string.back, R.string.home, R.string.main_menu, R.string.voice_search, R.string.info, R.string.systems, R.string.genres, R.string.collections, R.string.favorites, R.string.played_games, R.string.all_games, R.string.options, R.string.search, R.string.sort_menu, R.string.select_random, R.string.page_menu, R.string.media_pause, R.string.media_play, R.string.media_next};

    /* renamed from: d0 */
    static final int[] f9498d0 = {1, 16, 4, 3, 26, 17, 18, 28, 19, 23, 20, 21, 27, 15, 25, 5, 29, 30, 31};

    /* renamed from: e0 */
    LinearLayout f9499e0 = null;

    /* renamed from: f0 */
    LinearLayout f9500f0 = null;
    ...
    /* renamed from: s0 */
    Handler f9513s0 = new Handler();

    /* renamed from: t0 */
    String f9514t0 = "";

    /* renamed from: u0 */
    boolean f9515u0 = false;

    /* renamed from: v0 */
    boolean f9516v0 = false;

    /* renamed from: w0 */
    boolean f9517w0 = false;

    /* renamed from: x0 */
    boolean f9518x0 = false;
    ...
    class View$OnClickListenerC2803a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            C2219c3 c3Var = AbstractActivityC2802v3.this.f9275w;
            ...
            v3Var.mo9367H1(v3Var.f9519y0, true);
        }
    }
    ...
    class View$OnClickListenerC2809g implements View.OnClickListener {
        ...
        /* renamed from: b */
        final /* synthetic */ AbstractC2531p1 f9526b;

        /* renamed from: c */
        final /* synthetic */ View f9527c;

        /* renamed from: d */
        final /* synthetic */ LinearLayout f9528d;

        /* renamed from: e */
        final /* synthetic */ LinearLayout f9529e;

        View$OnClickListenerC2809g(AbstractC2531p1 p1Var, View view, LinearLayout linearLayout, LinearLayout linearLayout2) {
            this.f9526b = p1Var;
            this.f9527c = view;
            this.f9528d = linearLayout;
            this.f9529e = linearLayout2;
        }

        public void onClick(View view) {
            this.f9526b.mo8898Z2("none");
            AbstractActivityC2802v3.this.mo9366F1("nont", this.f9527c, this.f9528d, this.f9529e);
    ...
    class View$OnClickListenerC2810h implements View.OnClickListener {
        ...
        /* renamed from: b */
        final /* synthetic */ AbstractC2531p1 f9531b;

        /* renamed from: c */
        final /* synthetic */ View f9532c;

        /* renamed from: d */
        final /* synthetic */ LinearLayout f9533d;

        /* renamed from: e */
        final /* synthetic */ LinearLayout f9534e;
        ...
        View$OnClickListenerC2810h(AbstractC2531p1 p1Var, View view, LinearLayout linearLayout, LinearLayout linearLayout2) {
            ...
            this.f9534e = linearLayout2;
        }

        public void onClick(View view) {
            this.f9531b.mo8898Z2("default");
            AbstractActivityC2802v3.this.mo9366F1("default", this.f9532c, this.f9533d, this.f9534e);
            AbstractActivityC2802v3.this.mo8911v(null);
        }
    }
    ...
    class View$OnClickListenerC2811i implements View.OnClickListener {
        ...
        /* renamed from: b */
        final /* synthetic */ AbstractC2531p1 f9536b;

        /* renamed from: c */
        final /* synthetic */ View f9537c;

        /* renamed from: d */
        final /* synthetic */ LinearLayout f9538d;

        /* renamed from: e */
        final /* synthetic */ LinearLayout f9539e;

        View$OnClickListenerC2811i(AbstractC2531p1 p1Var, View view, LinearLayout linearLayout, LinearLayout linearLayout2) {
            this.f9536b = p1Var;
            this.f9537c = view;
            this.f9538d = linearLayout;
            this.f9539e = linearLayout2;
        }

        public void onClick(View view) {
            C2774t3 t3Var = C2553q3.f8899a;
            if (t3Var != null) {
                if (t3Var.f9423s.equals("")) {
                ...
                this.f9536b.mo8898Z2("icons_top");
                AbstractActivityC2802v3.this.mo9366F1("icons_top", this.f9537c, this.f9538d, this.f9539e);
                AbstractActivityC2802v3.this.mo8911v(null);
            }
        }
    }
    ...
    class View$OnClickListenerC2812j implements View.OnClickListener {
        ...
        /* renamed from: b */
        final /* synthetic */ AbstractC2531p1 f9541b;

        /* renamed from: c */
        final /* synthetic */ View f9542c;

        /* renamed from: d */
        final /* synthetic */ LinearLayout f9543d;

        /* renamed from: e */
        final /* synthetic */ LinearLayout f9544e;

        View$OnClickListenerC2812j(AbstractC2531p1 p1Var, View view, LinearLayout linearLayout, LinearLayout linearLayout2) {
            this.f9541b = p1Var;
            this.f9542c = view;
            this.f9543d = linearLayout;
            this.f9544e = linearLayout2;
        }
        ...
        public void onClick(View view) {
            ...
            if (t3Var != null) {
                ...
                this.f9541b.mo8898Z2("icons_bottom");
                AbstractActivityC2802v3.this.mo9366F1("icons_bottom", this.f9542c, this.f9543d, this.f9544e);
                AbstractActivityC2802v3.this.mo8911v(null);
            }
        }
    }
    ...
    class RunnableC2813k implements Runnable {
        ...
        public void run() {
            ...
            if (AbstractActivityC2802v3.this.f9275w.mo8198v()) {
            ...
            AbstractActivityC2802v3.this.f9513s0.postDelayed(this, 500);
        }
    }
    ...
    class DialogInterface$OnClickListenerC2814l implements DialogInterface.OnClickListener {
        ...
        /* renamed from: b */
        final /* synthetic */ AbstractC2531p1 f9547b;
    ...
    public class DialogInterface$OnClickListenerC2816n implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            boolean z = false;
            for (int i2 = 0; i2 < this.f9551b; i2++) {
                if (this.f9552c[i2]) {
                    z = true;
                }
            }
            if (z) {
                for (int i3 = 0; i3 < this.f9551b; i3++) {
                    AbstractActivityC2802v3 v3Var = AbstractActivityC2802v3.this;
                    v3Var.f9503i0[i3] = this.f9552c[i3];
                    C2219c3 c3Var = v3Var.f9275w;
                    c3Var.mo8153B("icon_" + AbstractActivityC2802v3.f9496b0[i3] + "_enabled", this.f9552c[i3]);
                }
                AbstractActivityC2802v3.this.mo8911v(null);
                return;
            }
    ...
    public class View$OnClickListenerC2817o implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            AbstractActivityC2802v3.this.f9510p0 = this.f9554b;
            view.clearFocus();
            AbstractActivityC2802v3.this.mo8945z1(this.f9555c);
            AbstractActivityC2802v3.this.mo8914G1(false);
        }
    }
        ...
        public void onFocusChange(View view, boolean z) {
            ...
            if (!z) {
                ...
                if (!zArr[i]) {
                    ...
                    AbstractActivityC2802v3.this.f9502h0[this.f9558a] = true;
                }
            }
        }
    }
    ...
    public class RunnableC2824v implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ AbstractC2531p1 f9564b;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:38:0x00c4, code lost:
            if (r13.f9565c.mo9128C1() != false) goto L_0x00b4;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:45:0x00e5, code lost:
            if (r13.f9564b.mo8248r2() >= 0) goto L_0x00b4;
         */
    ...
    public void mo9365A1(String str) {
        ...
        if (k1 != null) {
            if ((str.equals("icons_top") || str.equals("icons_bottom")) && (linearLayout = this.f9499e0) != null) {
    ...
    public View mo8904I() {
        LinearLayout linearLayout;
        AbstractC2531p1 k1 = mo8280k1();
        return (k1 == null || k1.mo8409w2().equals("default") || (linearLayout = this.f9499e0) == null) ? this.f9512r0 : linearLayout;
    }
    ...
    public void mo9368I1(int i) {
        ...
        String str = this.f9519y0;
        str.hashCode();
        if (!str.equals("icons_top")) {
            if (str.equals("icons_bottom") && childAt.getId() != R.id.pager) {
                linearLayout.removeView(this.f9499e0);
                linearLayout.addView(this.f9499e0);
            }
        } else if (childAt.getId() != R.id.icons_top) {
            linearLayout.removeView(this.f9499e0);
            linearLayout.addView(this.f9499e0, 1);
        }
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.f9499e0.getLayoutParams();
        layoutParams.height = i;
        this.f9499e0.setLayoutParams(layoutParams);
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f9500f0.getLayoutParams();
        layoutParams2.gravity = this.f9519y0.equals("icons_top") ? 48 : 80;
        layoutParams2.height = i;
        this.f9500f0.setLayoutParams(layoutParams2);
    }
    ...
    public boolean mo9369J1(boolean z, boolean z2) {
        ...
        if (this.f9500f0 == null) {
            return false;
        }
        if (!this.f9519y0.equals("icons_top") && !this.f9519y0.equals("icons_bottom")) {
            return false;
        }
        boolean z3 = this.f9506l0;
        if (z) {
            if (!z3 && (imageView4 = this.f9509o0) != null) {
                this.f9500f0.addView(imageView4, 0);
            }
        } else if (z3 && (imageView3 = this.f9509o0) != null) {
            this.f9500f0.removeView(imageView3);
        }
        this.f9506l0 = z;
        if (!this.f9275w.mo8198v()) {
            if (this.f9505k0 && (imageView2 = this.f9508n0) != null) {
                this.f9500f0.removeView(imageView2);
            }
            this.f9505k0 = false;
        } else {
            if (!this.f9505k0 && (imageView = this.f9508n0) != null) {
                this.f9500f0.addView(imageView);
            }
            if (this.f9508n0 != null) {
                ...
                this.f9508n0.setImageDrawable(drawable);
            }
            this.f9505k0 = true;
        }
        this.f9500f0.postInvalidate();
        return true;
    }
    ...
    public void mo9370K1() {
        boolean z = false;
        boolean z2 = this.f9275w.mo8191o() || this.f9275w.mo8186i();
        if (this.f9275w.mo8198v() && this.f9517w0) {
            z = true;
        }
        if (mo9369J1(z2, this.f9517w0)) {
            return;
        }
        if ((!this.f8060T && z2 != this.f9515u0) || z != this.f9516v0) {
    ...
    public void mo8905W(String str) {
        if (!str.equals(this.f9514t0)) {
            this.f9514t0 = str;
            try {
                Toolbar toolbar = this.f9512r0;
                if (toolbar != null) {
    ...
    /* renamed from: e */
    public void mo8906e() {
        if ((this.f9519y0.equals("icons_top") || this.f9519y0.equals("icons_bottom")) && this.f9499e0 != null) {
            mo8914G1(true);
            int i = this.f9510p0;
            if (i >= 0) {
                boolean[] zArr = this.f9501g0;
                if (i < zArr.length && zArr[i]) {
                    ImageView imageView = this.f9507m0[i];
                    if (imageView != null) {
            ...
            int i2 = 0;
            while (true) {
                boolean[] zArr2 = this.f9501g0;
                if (i2 >= zArr2.length) {
                    return;
                }
                if (zArr2[i2]) {
                    this.f9510p0 = i2;
                    ImageView imageView2 = this.f9507m0[i2];
                    if (imageView2 != null) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f9512r0 = toolbar;
        mo250S0(toolbar);
        String[] strArr = f9496b0;
        this.f9501g0 = new boolean[strArr.length];
        this.f9502h0 = new boolean[strArr.length];
        this.f9503i0 = new boolean[strArr.length];
        this.f9504j0 = new boolean[strArr.length];
        this.f9507m0 = new ImageView[strArr.length];
        int i = 0;
        while (true) {
            String[] strArr2 = f9496b0;
            if (i < strArr2.length) {
                boolean[] zArr = this.f9503i0;
                C2219c3 c3Var = this.f9275w;
                zArr[i] = c3Var.mo8180c("icon_" + strArr2[i] + "_enabled", true);
                this.f9504j0[i] = false;
                this.f9507m0[i] = null;
                i++;
            } else {
                return;
    ...
    public void onPause() {
        super.onPause();
        this.f9513s0.removeCallbacksAndMessages(null);
    }
    ...
    public void onResume() {
        super.onResume();
        this.f9513s0.post(new RunnableC2813k());
    }
    ...
    public void mo9371w1() {
        int length = f9497c0.length;
        String[] strArr = new String[length];
        boolean[] zArr = new boolean[length];
        for (int i = 0; i < length; i++) {
            strArr[i] = getString(f9497c0[i]);
            zArr[i] = this.f9503i0[i];
        }
    ...
    public void mo9373y1() {
        if (!C2553q3.f8899a.f9423s.equals("")) {
            File file = new File(C2553q3.f8899a.f9423s);
            if (file.exists()) {
                ...
                while (true) {
                    ...
                    if (i < strArr.length) {
                        if (new File(file, strArr[i] + ".png").exists()) {
                            ...
                            this.f9507m0[i] = imageView;
                            imageView.setOnClickListener(new View$OnClickListenerC2817o(i, f9498d0[i]));
                        ...
                        this.f9508n0 = (ImageView) getLayoutInflater().inflate(R.layout.notification_announcement, (ViewGroup) null);
                        ...
                        this.f9508n0.setImageDrawable(drawable);
                        this.f9508n0.setOnFocusChangeListener(new View$OnFocusChangeListenerC2820r());
                        this.f9508n0.setOnClickListener(new View$OnClickListenerC2821s());
                        this.f9509o0 = (ImageView) getLayoutInflater().inflate(R.layout.notification_working, (ViewGroup) null);
                        Drawable drawable2 = resources.getDrawable(2131165335);
                        drawable2.mutate();
                        drawable2.setColorFilter(new PorterDuffColorFilter(C2553q3.m11137w(), PorterDuff.Mode.SRC_ATOP));
                        this.f9509o0.setImageDrawable(drawable2);
                        this.f9509o0.setOnFocusChangeListener(new View$OnFocusChangeListenerC2822t());
                        this.f9509o0.setOnClickListener(new View$OnClickListenerC2823u());
                        this.f9505k0 = false;
                        this.f9506l0 = false;
                        return;
                    }
