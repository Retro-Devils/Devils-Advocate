...
public abstract class AbstractActivityC2260e0 extends ActivityC2800v1 implements AbstractC2531p1.AbstractC2532a, MyViewPager.AbstractC2120a {
    ...
    /* renamed from: T */
    boolean f8060T = false;

    /* renamed from: U */
    boolean f8061U = false;

    /* renamed from: V */
    boolean f8062V = false;
    ...
    /* renamed from: Z */
    ViewStub f8066Z = null;

    /* renamed from: a0 */
    ViewStub f8067a0 = null;
    ...
    class C2261a implements C1205b.AbstractC1215j {
        ...
        public void mo6133a(int i, float f, int i2) {
            ...
            C2515o2 o2Var = e0Var.f8065Y;
            if (o2Var != null) {
                o2Var.mo8866q((AbstractC2531p1) e0Var.f8063W.mo8687o(i), i2);
            }
        }
        ...
        public void mo6135c(int i) {
            ...
            e0Var.f8060T = false;
            e0Var.mo8259H(false);
            AbstractC2531p1 p1Var = (AbstractC2531p1) AbstractActivityC2260e0.this.f8063W.mo8687o(i);
            if (p1Var != null && !AbstractActivityC2260e0.this.f8063W.mo8718v()) {
    ...
    public void mo8259H(boolean z) {
        View view;
        this.f8061U = z;
        if (z || this.f8067a0 != null) {
            if (this.f8067a0 == null) {
                ViewStub viewStub = (ViewStub) findViewById(R.id.stub_resize);
                this.f8067a0 = viewStub;
    ...
    public void mo8260K(int i) {
        this.f8063W.mo8720x(this.f8064X, i);
    }
    ...
    public void mo8261L() {
        Bundle bundle = new Bundle();
        bundle.putBoolean("grid", this.f9275w.mo8179b().equals("grid"));
    ...
    public void mo8267V(String str) {
        try {
            ...
            bundle.putString("title", this.f9277y.mo8568s(str));
            mo8278j1(4, bundle);
    ...
    /* renamed from: i */
    public void mo8275i() {
        int currentItem = this.f8064X.getCurrentItem() + 1;
        if (currentItem < this.f8063W.mo6058c()) {
            this.f8064X.mo6072K(currentItem, true);
        }
    }
    ...
    public void mo8276i0(String str, String str2, int i, int i2) {
        this.f8063W.mo8721y(this.f8064X, null, str2, i, i2);
    }
    ...
    public void mo8278j1(int i, Bundle bundle) {
        this.f8063W.mo8716t(this.f8064X, i, bundle);
    }
    ...
    public AbstractC2531p1 mo8280k1() {
        int currentItem = this.f8064X.getCurrentItem();
        if (currentItem >= 0) {
            return (AbstractC2531p1) this.f8063W.mo8687o(currentItem);
        }
        return null;
    }
    ...
    public long mo8283m0() {
        ...
        int currentItem = this.f8064X.getCurrentItem();
        if (currentItem < 1 || (p1Var = (AbstractC2531p1) this.f8063W.mo8687o(currentItem - 1)) == null) {
            return -1;
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        mo8254B().findItem(R.id.nav_kiosk).setTitle(this.f9275w.mo8196t() ? R.string.exit_kiosk : R.string.kiosk);
        ...
        if (bundle != null) {
            try {
                ...
                this.f8063W = new C2458l2(this);
            }
        }
        MyViewPager myViewPager = (MyViewPager) findViewById(R.id.pager);
        this.f8064X = myViewPager;
        myViewPager.setAdapter(this.f8063W);
        this.f8064X.setOffscreenPageLimit(1);
        this.f8064X.mo7949P(this);
        this.f8064X.mo6080b(new C2261a());
    }
    ...
    public void onSaveInstanceState(Bundle bundle) {
        this.f8063W.mo8691s(this.f8064X.getCurrentItem(), this.f8064X.getOffscreenPageLimit());
        bundle.putParcelable("state", this.f8063W.mo6065j());
    ...
    public void mo8288p() {
        Bundle bundle = new Bundle();
        bundle.putBoolean("grid", this.f9275w.mo8193q("systems_list_type", "grid").equals("grid"));
        mo8278j1(3, bundle);
    }
    ...
    public void mo8290q(String str, C2369h0 h0Var, int i) {
        this.f8063W.mo8721y(this.f8064X, h0Var, null, -1, i);
    }

    @Override // com.digdroid.alman.dig.AbstractC2531p1.AbstractC2532a
    /* renamed from: q0 */
    public void mo8291q0() {
        this.f8063W.mo8690r(this.f8064X.getCurrentItem() + 1);
    }
    ...
    /* renamed from: r */
    public void mo8293r() {
        this.f8063W.mo8719w(this.f8064X);
    }
    ...
    public void mo8298u0() {
        int currentItem = this.f8064X.getCurrentItem();
        this.f8063W.mo8690r(currentItem);
        this.f8063W.mo8717u(currentItem);
        this.f8064X.mo6072K(currentItem - 1, false);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: u1 */
    public void mo8299u1() {
        this.f8063W.mo8690r(0);
        this.f8063W.mo8717u(0);
    }
    ...
    public void mo8301v1() {
        this.f8064X.post(new RunnableC2262b());
    }

    @Override // com.digdroid.alman.dig.AbstractC2531p1.AbstractC2532a
    /* renamed from: w */
    public void mo8302w(boolean z) {
        mo243L0().mo204s(z && !this.f9275w.mo8196t());
    }
