...
public final class C3003h0 extends AbstractC3004i implements Handler.Callback {
    ...
    /* renamed from: c */
    private final HashMap<AbstractC3004i.C3005a, ServiceConnectionC3006i0> f9991c = new HashMap<>();
    ...
    /* renamed from: f */
    private final C1290a f9994f;

    /* renamed from: g */
    private final long f9995g;

    /* renamed from: h */
    private final long f9996h;

    C3003h0(Context context) {
        this.f9992d = context.getApplicationContext();
        this.f9993e = new HandlerC1312d(context.getMainLooper(), this);
        this.f9994f = C1290a.m6804a();
        this.f9995g = 5000;
        this.f9996h = 300000;
    }
    ...
    public final boolean mo9771c(AbstractC3004i.C3005a aVar, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.f9991c) {
            ServiceConnectionC3006i0 i0Var = this.f9991c.get(aVar);
            if (i0Var == null) {
                i0Var = new ServiceConnectionC3006i0(this, aVar);
                i0Var.mo9786e(serviceConnection, str);
                i0Var.mo9789h(str);
                this.f9991c.put(aVar, i0Var);
            } else {
                this.f9993e.removeMessages(0, aVar);
    ...
    public final void mo9772d(AbstractC3004i.C3005a aVar, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.f9991c) {
            ...
            if (i0Var == null) {
                ...
                if (i0Var.mo9791j()) {
                    this.f9993e.sendMessageDelayed(this.f9993e.obtainMessage(0, aVar), this.f9995g);
                }
            } else {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i == 0) {
            ...
            synchronized (this.f9991c) {
                ...
                ServiceConnectionC3006i0 i0Var2 = this.f9991c.get(aVar2);
