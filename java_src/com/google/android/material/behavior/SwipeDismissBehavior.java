...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.AbstractC0337c<V> {
    ...
    /* renamed from: b */
    AbstractC3065c f10121b;

    /* renamed from: c */
    private boolean f10122c;

    /* renamed from: d */
    private float f10123d = 0.0f;
    ...
    /* renamed from: j */
    private final C1052c.AbstractC1055c f10129j = new C3063a();
    ...
    class C3063a extends C1052c.AbstractC1055c {
        ...
        public void mo2487j(int i) {
            AbstractC3065c cVar = SwipeDismissBehavior.this.f10121b;
            if (cVar != null) {
                cVar.mo9925b(i);
            }
        }
        ...
        public void mo2488k(View view, int i, int i2, int i3, int i4) {
            float width = ((float) this.f10130a) + (((float) view.getWidth()) * SwipeDismissBehavior.this.f10127h);
            float width2 = ((float) this.f10130a) + (((float) view.getWidth()) * SwipeDismissBehavior.this.f10128i);
            float f = (float) i;
            if (f <= width) {
                view.setAlpha(1.0f);
            } else if (f >= width2) {
        ...
        public void mo2489l(View view, float f, float f2) {
            ...
            if (SwipeDismissBehavior.this.f10120a.mo5648M(i, view.getTop())) {
                C1013s.m5750a0(view, new RunnableC3066d(view, z));
            } else if (z && (cVar = SwipeDismissBehavior.this.f10121b) != null) {
                cVar.mo9924a(view);
            }
        }
    ...
    public class C3064b implements AbstractC0987f {
        ...
        public boolean mo5529a(View view, AbstractC0987f.AbstractC0988a aVar) {
            ...
            int i = SwipeDismissBehavior.this.f10125f;
            if ((i == 0 && z2) || (i == 1 && !z2)) {
                z = true;
            }
            int width = view.getWidth();
    ...
    private class RunnableC3066d implements Runnable {
        ...
        public void run() {
            AbstractC3065c cVar;
            C1052c cVar2 = SwipeDismissBehavior.this.f10120a;
            if (cVar2 != null && cVar2.mo5656m(true)) {
                C1013s.m5750a0(this.f10134b, this);
            } else if (this.f10135c && (cVar = SwipeDismissBehavior.this.f10121b) != null) {
                cVar.mo9924a(this.f10134b);
            }
        }
    }
    ...
    private void m12591H(ViewGroup viewGroup) {
        if (this.f10120a == null) {
            this.f10120a = this.f10124e ? C1052c.m5971n(viewGroup, this.f10123d, this.f10129j) : C1052c.m5972o(viewGroup, this.f10129j);
        }
    }
    ...
    private void m12593N(View view) {
        ...
        if (mo9919E(view)) {
            C1013s.m5758e0(view, C0979c.C0980a.f4721u, null, new C3064b());
        }
    }
    ...
    public void mo9920J(float f) {
        this.f10128i = m12589F(0.0f, f, 1.0f);
    }
    ...
    public void mo9922L(float f) {
        this.f10127h = m12589F(0.0f, f, 1.0f);
    }
    ...
    public boolean mo2097k(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        return this.f10120a.mo5649N(motionEvent);
    }
