...
class C3264c extends C1455g {
    ...
    /* renamed from: A */
    private final RectF f10917A;

    /* renamed from: B */
    private int f10918B;

    /* renamed from: z */
    private final Paint f10919z;
    ...
    C3264c(C1462k kVar) {
        ...
        this.f10919z = new Paint(1);
        m13657o0();
        this.f10917A = new RectF();
    }

    /* renamed from: i0 */
    private void m13654i0(Canvas canvas) {
        if (!m13658p0(getCallback())) {
            canvas.restoreToCount(this.f10918B);
        }
    }
    ...
    private void m13656l0(Canvas canvas) {
        this.f10918B = Build.VERSION.SDK_INT >= 21 ? canvas.saveLayer(0.0f, 0.0f, (float) canvas.getWidth(), (float) canvas.getHeight(), null) : canvas.saveLayer(0.0f, 0.0f, (float) canvas.getWidth(), (float) canvas.getHeight(), null, 31);
    }

    /* renamed from: o0 */
    private void m13657o0() {
        this.f10919z.setStyle(Paint.Style.FILL_AND_STROKE);
        this.f10919z.setColor(-1);
        this.f10919z.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
    }
    ...
    public void draw(Canvas canvas) {
        m13655j0(canvas);
        super.draw(canvas);
        canvas.drawRect(this.f10917A, this.f10919z);
        m13654i0(canvas);
    }
