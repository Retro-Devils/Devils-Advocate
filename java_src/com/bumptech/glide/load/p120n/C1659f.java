...
public class C1659f {
    ...
    /* renamed from: a */
    private static final AbstractC1657e.AbstractC1658a<?> f6673a = new C1660a();

    /* renamed from: b */
    private final Map<Class<?>, AbstractC1657e.AbstractC1658a<?>> f6674b = new HashMap();
    ...
    public synchronized <T> AbstractC1657e<T> mo7114a(T t) {
        ...
        C2081j.m9432d(t);
        aVar = this.f6674b.get(t.getClass());
        if (aVar == null) {
            Iterator<AbstractC1657e.AbstractC1658a<?>> it = this.f6674b.values().iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
    ...
    public synchronized void mo7115b(AbstractC1657e.AbstractC1658a<?> aVar) {
        this.f6674b.put(aVar.mo7112a(), aVar);
    }
}
