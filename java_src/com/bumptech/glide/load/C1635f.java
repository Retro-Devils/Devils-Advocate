...
public final class C1635f {
    ...
    class C1636a implements AbstractC1642g {
        ...
        /* renamed from: a */
        final /* synthetic */ InputStream f6640a;

        C1636a(InputStream inputStream) {
            this.f6640a = inputStream;
        }
        ...
        public ImageHeaderParser.ImageType mo7073a(ImageHeaderParser imageHeaderParser) {
            try {
                return imageHeaderParser.mo7070c(this.f6640a);
            } finally {
                this.f6640a.reset();
            }
        }
    ...
    class C1637b implements AbstractC1642g {
        ...
        /* renamed from: a */
        final /* synthetic */ ByteBuffer f6641a;
        ...
        /* renamed from: a */
        public ImageHeaderParser.ImageType mo7073a(ImageHeaderParser imageHeaderParser) {
            return imageHeaderParser.mo7068a(this.f6641a);
        }
    }
    ...
    class C1638c implements AbstractC1642g {
        ...
        /* renamed from: a */
        final /* synthetic */ C1671m f6642a;

        /* renamed from: b */
        final /* synthetic */ AbstractC1690b f6643b;
        ...
        public com.bumptech.glide.load.ImageHeaderParser.ImageType mo7073a(com.bumptech.glide.load.ImageHeaderParser r5) {
            /*
                ...
                com.bumptech.glide.load.n.m r3 = r4.f6642a     // Catch:{ all -> 0x0027 }
                ...
                com.bumptech.glide.load.o.a0.b r3 = r4.f6643b     // Catch:{ all -> 0x0027 }
            ...
            L_0x001e:
                com.bumptech.glide.load.n.m r0 = r4.f6642a
                r0.mo7110a()
                return r5
            L_0x0024:
                r5 = move-exception
    ...
    class C1639d implements AbstractC1641f {
        ...
        /* renamed from: a */
        final /* synthetic */ InputStream f6644a;

        /* renamed from: b */
        final /* synthetic */ AbstractC1690b f6645b;
        ...
        public int mo7074a(ImageHeaderParser imageHeaderParser) {
            try {
                return imageHeaderParser.mo7069b(this.f6644a, this.f6645b);
            } finally {
                this.f6644a.reset();
            }
        }
    ...
    class C1640e implements AbstractC1641f {
        ...
        /* renamed from: a */
        final /* synthetic */ C1671m f6646a;

        /* renamed from: b */
        final /* synthetic */ AbstractC1690b f6647b;
        ...
        public int mo7074a(com.bumptech.glide.load.ImageHeaderParser r5) {
            /*
                ...
                com.bumptech.glide.load.n.m r3 = r4.f6646a     // Catch:{ all -> 0x0029 }
                ...
                com.bumptech.glide.load.o.a0.b r3 = r4.f6647b     // Catch:{ all -> 0x0029 }
                r1.<init>(r2, r3)     // Catch:{ all -> 0x0029 }
                com.bumptech.glide.load.o.a0.b r0 = r4.f6647b     // Catch:{ all -> 0x0026 }
                int r5 = r5.mo7069b(r1, r0)     // Catch:{ all -> 0x0026 }
                r1.close()     // Catch:{ IOException -> 0x0020 }
            L_0x0020:
                com.bumptech.glide.load.n.m r0 = r4.f6646a
                r0.mo7110a()
                return r5
            L_0x0026:
                r5 = move-exception
