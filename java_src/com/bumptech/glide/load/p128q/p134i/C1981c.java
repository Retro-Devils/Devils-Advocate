...
public final class C1981c implements AbstractC1983e<Drawable, byte[]> {
    ...
    /* renamed from: a */
    private final AbstractC1695e f7325a;

    /* renamed from: b */
    private final AbstractC1983e<Bitmap, byte[]> f7326b;

    /* renamed from: c */
    private final AbstractC1983e<C1966c, byte[]> f7327c;
    ...
    public AbstractC1794v<byte[]> mo7624a(AbstractC1794v<Drawable> vVar, C1647i iVar) {
        ...
        if (c instanceof BitmapDrawable) {
            return this.f7326b.mo7624a(C1910e.m8673g(((BitmapDrawable) c).getBitmap(), this.f7325a), iVar);
        }
        if (c instanceof C1966c) {
            return this.f7327c.mo7624a(m8950b(vVar), iVar);
        }
        return null;
    }
}
