...
public class C1970f implements AbstractC1651m<C1966c> {
    ...
    public AbstractC1794v<C1966c> mo7091b(Context context, AbstractC1794v<C1966c> vVar, int i, int i2) {
        ...
        AbstractC1794v<Bitmap> b = this.f7283b.mo7091b(context, eVar, i, i2);
        if (!eVar.equals(b)) {
            eVar.mo7361f();
        }
        c.mo7590m(this.f7283b, b.mo7358c());
        return vVar;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof C1970f) {
            return this.f7283b.equals(((C1970f) obj).f7283b);
        }
        return false;
    }
