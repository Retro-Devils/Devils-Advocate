...
public class C1978j implements AbstractC1649k<InputStream, C1966c> {
    ...
    /* renamed from: a */
    private final List<ImageHeaderParser> f7319a;

    /* renamed from: b */
    private final AbstractC1649k<ByteBuffer, C1966c> f7320b;

    /* renamed from: c */
    private final AbstractC1690b f7321c;
    ...
    public AbstractC1794v<C1966c> mo7088a(InputStream inputStream, int i, int i2, C1647i iVar) {
        ...
        return this.f7320b.mo7088a(ByteBuffer.wrap(e), i, i2, iVar);
    }

    /* renamed from: d */
    public boolean mo7089b(InputStream inputStream, C1647i iVar) {
        return !((Boolean) iVar.mo7084c(C1977i.f7318b)).booleanValue() && C1635f.m7858e(this.f7319a, inputStream, this.f7321c) == ImageHeaderParser.ImageType.GIF;
    }
}
