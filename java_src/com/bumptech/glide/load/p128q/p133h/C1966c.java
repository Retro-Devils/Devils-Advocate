...
public class C1966c extends Drawable implements C1971g.AbstractC1973b, Animatable {
    ...
    /* renamed from: l */
    private List<AbstractC1183b> f7281l;
    ...
    C1966c(C1967a aVar) {
        this.f7275f = true;
        this.f7277h = -1;
        this.f7271b = (C1967a) C2081j.m9432d(aVar);
    }
    ...
    /* renamed from: j */
    private void m8893j() {
        List<AbstractC1183b> list = this.f7281l;
        if (list != null) {
            int size = list.size();
            for (int i = 0; i < size; i++) {
                this.f7281l.get(i).mo5907a(this);
            }
        }
    }
    ...
    /* renamed from: n */
    private void m8895n() {
        C2081j.m9429a(!this.f7274e, "You cannot start a recycled Drawable. Ensure thatyou clear any references to the Drawable when clearing the corresponding request.");
        if (this.f7271b.f7282a.mo7606f() != 1) {
            if (!this.f7272c) {
                this.f7272c = true;
                this.f7271b.f7282a.mo7612r(this);
            } else {
                return;
            }
        }
    ...
    private void m8896o() {
        this.f7272c = false;
        this.f7271b.f7282a.mo7613s(this);
    }
    ...
    public ByteBuffer mo7578c() {
        return this.f7271b.f7282a.mo7602b();
    }

    public void draw(Canvas canvas) {
        if (!this.f7274e) {
            if (this.f7278i) {
                Gravity.apply(C0763j.f3614I0, getIntrinsicWidth(), getIntrinsicHeight(), getBounds(), m8891d());
                this.f7278i = false;
            }
            canvas.drawBitmap(this.f7271b.f7282a.mo7603c(), (Rect) null, m8891d(), m8892h());
        }
    }

    /* renamed from: e */
    public Bitmap mo7580e() {
        return this.f7271b.f7282a.mo7605e();
    }

    /* renamed from: f */
    public int mo7581f() {
        return this.f7271b.f7282a.mo7606f();
    }

    /* renamed from: g */
    public int mo7582g() {
        return this.f7271b.f7282a.mo7604d();
    }
    ...
    public int getIntrinsicHeight() {
        return this.f7271b.f7282a.mo7607h();
    }

    public int getIntrinsicWidth() {
        return this.f7271b.f7282a.mo7609k();
    }
    ...
    /* renamed from: i */
    public int mo7587i() {
        return this.f7271b.f7282a.mo7608j();
    }
    ...
    public void mo7589k() {
        this.f7274e = true;
        this.f7271b.f7282a.mo7601a();
    }

    /* renamed from: m */
    public void mo7590m(AbstractC1651m<Bitmap> mVar, Bitmap bitmap) {
        this.f7271b.f7282a.mo7611o(mVar, bitmap);
    }
    ...
    public boolean setVisible(boolean z, boolean z2) {
        C2081j.m9429a(!this.f7274e, "Cannot change the visibility of a recycled resource. Ensure that you unset the Drawable from your View before changing the View's visibility.");
        this.f7275f = z;
        if (!z) {
            m8896o();
        } else if (this.f7273d) {
