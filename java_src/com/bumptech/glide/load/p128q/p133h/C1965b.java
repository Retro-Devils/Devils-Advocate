...
public final class C1965b implements AbstractC1996a.AbstractC1997a {
    ...
    /* renamed from: a */
    private final AbstractC1695e f7269a;

    /* renamed from: b */
    private final AbstractC1690b f7270b;
    ...
    public int[] mo7571a(int i) {
        AbstractC1690b bVar = this.f7270b;
    ...
    public Bitmap mo7572b(int i, int i2, Bitmap.Config config) {
        return this.f7269a.mo7184e(i, i2, config);
    }
