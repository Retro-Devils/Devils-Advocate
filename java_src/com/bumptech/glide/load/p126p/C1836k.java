...
public final class C1836k implements AbstractC1843n<Uri, File> {
    ...
    public static class C1838b implements AbstractC1655d<File> {
        ...
        /* renamed from: b */
        private static final String[] f7072b = {"_data"};

        /* renamed from: c */
        private final Context f7073c;

        /* renamed from: d */
        private final Uri f7074d;
        ...
        public void mo7101e(EnumC1616g gVar, AbstractC1655d.AbstractC1656a<? super File> aVar) {
            Cursor query = this.f7073c.getContentResolver().query(this.f7074d, f7072b, null, null, null);
            String str = null;
            if (query != null) {
                try {
            ...
            if (TextUtils.isEmpty(str)) {
                aVar.mo7108d(new FileNotFoundException("Failed to find file path for: " + this.f7074d));
                return;
            }
    ...
    public AbstractC1843n.C1844a<File> mo7393a(Uri uri, int i, int i2, C1647i iVar) {
        return new AbstractC1843n.C1844a<>(new C2067d(uri), new C1838b(this.f7070a, uri));
    }
