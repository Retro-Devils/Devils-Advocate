...
public class C1733j {
    ...
    /* renamed from: a */
    private final C2078g<AbstractC1643g, String> f6788a = new C2078g<>(1000);

    /* renamed from: b */
    private final AbstractC0958f<C1735b> f6789b = C2084a.m9456d(10, new C1734a());
    ...
    public static final class C1735b implements C2084a.AbstractC2090f {
        ...
        /* renamed from: b */
        final MessageDigest f6791b;

        /* renamed from: c */
        private final AbstractC2093c f6792c = AbstractC2093c.m9473a();

        C1735b(MessageDigest messageDigest) {
            this.f6791b = messageDigest;
        }
    ...
    private String m8160a(AbstractC1643g gVar) {
        C1735b bVar = (C1735b) C2081j.m9432d(this.f6789b.mo5399b());
        try {
            gVar.mo7075a(bVar.f6791b);
            return C2082k.m9452s(bVar.f6791b.digest());
        } finally {
            this.f6789b.mo5398a(bVar);
        }
    }
    ...
    public String mo7237b(AbstractC1643g gVar) {
        ...
        synchronized (this.f6788a) {
            g = this.f6788a.mo7856g(gVar);
        }
        if (g == null) {
            g = m8160a(gVar);
        }
        synchronized (this.f6788a) {
            this.f6788a.mo7858k(gVar, g);
        }
        return g;
    }
}
