...
public class C1709n implements AbstractC1707l {
    ...
    /* renamed from: a */
    private static final Bitmap.Config[] f6747a;

    /* renamed from: b */
    private static final Bitmap.Config[] f6748b;

    /* renamed from: c */
    private static final Bitmap.Config[] f6749c = {Bitmap.Config.RGB_565};

    /* renamed from: d */
    private static final Bitmap.Config[] f6750d = {Bitmap.Config.ARGB_4444};

    /* renamed from: e */
    private static final Bitmap.Config[] f6751e = {Bitmap.Config.ALPHA_8};

    /* renamed from: f */
    private final C1712c f6752f = new C1712c();

    /* renamed from: g */
    private final C1698h<C1711b, Bitmap> f6753g = new C1698h<>();

    /* renamed from: h */
    private final Map<Bitmap.Config, NavigableMap<Integer, Integer>> f6754h = new HashMap();
    ...
    public static /* synthetic */ class C1710a {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.bumptech.glide.load.p122o.p123a0.C1709n.C1710a.f6755a = r0
                android.graphics.Bitmap$Config r1 = android.graphics.Bitmap.Config.ARGB_8888     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = com.bumptech.glide.load.p122o.p123a0.C1709n.C1710a.f6755a     // Catch:{ NoSuchFieldError -> 0x001d }
                android.graphics.Bitmap$Config r1 = android.graphics.Bitmap.Config.RGB_565     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = com.bumptech.glide.load.p122o.p123a0.C1709n.C1710a.f6755a     // Catch:{ NoSuchFieldError -> 0x0028 }
                android.graphics.Bitmap$Config r1 = android.graphics.Bitmap.Config.ARGB_4444     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = com.bumptech.glide.load.p122o.p123a0.C1709n.C1710a.f6755a     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    public static final class C1711b implements AbstractC1708m {
        ...
        /* renamed from: a */
        private final C1712c f6756a;

        /* renamed from: b */
        int f6757b;

        /* renamed from: c */
        private Bitmap.Config f6758c;
        ...
        public boolean equals(Object obj) {
            ...
            return this.f6757b == bVar.f6757b && C2082k.m9436c(this.f6758c, bVar.f6758c);
        }

        public int hashCode() {
            int i = this.f6757b * 31;
            Bitmap.Config config = this.f6758c;
            return i + (config != null ? config.hashCode() : 0);
        }

        public String toString() {
            return C1709n.m8104i(this.f6757b, this.f6758c);
        }
    }
    ...
    private C1711b m8103h(int i, Bitmap.Config config) {
        C1711b e = this.f6752f.mo7211e(i, config);
        ...
        for (Bitmap.Config config2 : j) {
            ...
            if (ceilingKey != null && ceilingKey.intValue() <= i * 8) {
                ...
                this.f6752f.mo7179c(e);
                return this.f6752f.mo7211e(ceilingKey.intValue(), config2);
            }
        }
        return e;
    }
    ...
    private static Bitmap.Config[] m8105j(Bitmap.Config config) {
        ...
        int i = C1710a.f6755a[config.ordinal()];
        if (i == 1) {
            return f6747a;
        }
        if (i == 2) {
    ...
    private NavigableMap<Integer, Integer> m8106k(Bitmap.Config config) {
        NavigableMap<Integer, Integer> navigableMap = this.f6754h.get(config);
        if (navigableMap != null) {
            return navigableMap;
        }
        TreeMap treeMap = new TreeMap();
        this.f6754h.put(config, treeMap);
        return treeMap;
    }
    ...
    public Bitmap mo7165c(int i, int i2, Bitmap.Config config) {
        ...
        Bitmap a = this.f6753g.mo7187a(h);
        if (a != null) {
            m8102g(Integer.valueOf(h.f6757b), a);
    ...
    public void mo7166d(Bitmap bitmap) {
        C1711b e = this.f6752f.mo7211e(C2082k.m9440g(bitmap), bitmap.getConfig());
        this.f6753g.mo7188d(e, bitmap);
        NavigableMap<Integer, Integer> k = m8106k(bitmap.getConfig());
        Integer num = (Integer) k.get(Integer.valueOf(e.f6757b));
        Integer valueOf = Integer.valueOf(e.f6757b);
        int i = 1;
        if (num != null) {
            i = 1 + num.intValue();
        }
    ...
    public String toString() {
        ...
        for (Map.Entry<Bitmap.Config, NavigableMap<Integer, Integer>> entry : this.f6754h.entrySet()) {
            sb.append(entry.getKey());
            sb.append('[');
            sb.append(entry.getValue());
            sb.append("], ");
        }
        if (!this.f6754h.isEmpty()) {
