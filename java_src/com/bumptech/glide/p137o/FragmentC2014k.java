...
public class FragmentC2014k extends Fragment {
    ...
    /* renamed from: b */
    private final C2002a f7423b;

    /* renamed from: c */
    private final AbstractC2019m f7424c;

    /* renamed from: d */
    private final Set<FragmentC2014k> f7425d;

    /* renamed from: e */
    private ComponentCallbacks2C1626k f7426e;

    /* renamed from: f */
    private FragmentC2014k f7427f;

    /* renamed from: g */
    private Fragment f7428g;
    ...
    FragmentC2014k(C2002a aVar) {
        this.f7424c = new C2015a();
        this.f7425d = new HashSet();
        this.f7423b = aVar;
    }

    /* renamed from: a */
    private void m9095a(FragmentC2014k kVar) {
        this.f7425d.add(kVar);
    }
    ...
    private Fragment m9096d() {
        ...
        return parentFragment != null ? parentFragment : this.f7428g;
    }
    ...
    private void m9098h(Activity activity) {
        ...
        this.f7427f = h;
        if (!equals(h)) {
            this.f7427f.m9095a(this);
        }
    }

    /* renamed from: i */
    private void m9099i(FragmentC2014k kVar) {
        this.f7425d.remove(kVar);
    }

    /* renamed from: l */
    private void m9100l() {
        FragmentC2014k kVar = this.f7427f;
        if (kVar != null) {
            kVar.m9099i(this);
            this.f7427f = null;
        }
    ...
    public Set<FragmentC2014k> mo7677b() {
        if (equals(this.f7427f)) {
            return Collections.unmodifiableSet(this.f7425d);
        }
        if (this.f7427f == null || Build.VERSION.SDK_INT < 17) {
            return Collections.emptySet();
        }
        HashSet hashSet = new HashSet();
        for (FragmentC2014k kVar : this.f7427f.mo7677b()) {
