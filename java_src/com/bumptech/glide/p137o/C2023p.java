...
public final class C2023p implements AbstractC2012i {
    ...
    /* renamed from: b */
    private final Set<AbstractC2055h<?>> f7457b = Collections.newSetFromMap(new WeakHashMap());

    @Override // com.bumptech.glide.p137o.AbstractC2012i
    /* renamed from: a */
    public void mo7041a() {
        for (AbstractC2055h hVar : C2082k.m9442i(this.f7457b)) {
            hVar.mo7041a();
        }
    }
