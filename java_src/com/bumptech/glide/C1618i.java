...
public class C1618i {
    ...
    /* renamed from: a */
    private final C1846p f6578a;

    /* renamed from: b */
    private final C2028a f6579b;

    /* renamed from: c */
    private final C2033e f6580c;

    /* renamed from: d */
    private final C2035f f6581d;

    /* renamed from: e */
    private final C1659f f6582e;

    /* renamed from: f */
    private final C1984f f6583f;

    /* renamed from: g */
    private final C2030b f6584g;

    /* renamed from: h */
    private final C2032d f6585h = new C2032d();

    /* renamed from: i */
    private final C2031c f6586i = new C2031c();

    /* renamed from: j */
    private final AbstractC0958f<List<Throwable>> f6587j;
    ...
    public C1618i() {
        ...
        this.f6587j = e;
        this.f6578a = new C1846p(e);
        this.f6579b = new C2028a();
        this.f6580c = new C2033e();
        this.f6581d = new C2035f();
        this.f6582e = new C1659f();
        this.f6583f = new C1984f();
        this.f6584g = new C2030b();
    ...
    private <Data, TResource, Transcode> List<C1761i<Data, TResource, Transcode>> m7783f(Class<Data> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        ...
        for (Class cls4 : this.f6580c.mo7730d(cls, cls2)) {
            for (Class cls5 : this.f6583f.mo7626b(cls4, cls3)) {
                arrayList.add(new C1761i(cls, cls4, cls5, this.f6580c.mo7729b(cls, cls4), this.f6583f.mo7625a(cls4, cls5), this.f6587j));
            }
        }
        return arrayList;
    }
    ...
    public <Data, TResource, Transcode> C1791t<Data, TResource, Transcode> mo7011h(Class<Data> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        C1791t<Data, TResource, Transcode> a = this.f6586i.mo7723a(cls, cls2, cls3);
        if (this.f6586i.mo7724c(a)) {
            return null;
        }
        if (a == null) {
            List<C1761i<Data, TResource, Transcode>> f = m7783f(cls, cls2, cls3);
            a = f.isEmpty() ? null : new C1791t<>(cls, cls2, cls3, f, this.f6587j);
            this.f6586i.mo7725d(cls, cls2, cls3, a);
        }
        return a;
    }
    ...
    public <Model> List<AbstractC1843n<Model, ?>> mo7012i(Model model) {
        return this.f6578a.mo7446d(model);
    }

    /* renamed from: j */
    public <Model, TResource, Transcode> List<Class<?>> mo7013j(Class<Model> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        List<Class<?>> a = this.f6585h.mo7726a(cls, cls2, cls3);
        if (a == null) {
            a = new ArrayList<>();
            for (Class<?> cls4 : this.f6578a.mo7445c(cls)) {
                for (Class<?> cls5 : this.f6580c.mo7730d(cls4, cls2)) {
                    if (!this.f6583f.mo7626b(cls5, cls3).isEmpty() && !a.contains(cls5)) {
                        a.add(cls5);
                    }
                }
            }
            this.f6585h.mo7727b(cls, cls2, cls3, Collections.unmodifiableList(a));
        }
        return a;
    }
    ...
    public <X> AbstractC1650l<X> mo7014k(AbstractC1794v<X> vVar) {
        AbstractC1650l<X> b = this.f6581d.mo7734b(vVar.mo7359d());
        if (b != null) {
            return b;
        }
    ...
    public <X> AbstractC1657e<X> mo7015l(X x) {
        return this.f6582e.mo7114a(x);
    }

    /* renamed from: m */
    public <X> AbstractC1633d<X> mo7016m(X x) {
        AbstractC1633d<X> b = this.f6579b.mo7719b(x.getClass());
        if (b != null) {
            return b;
        }
    ...
    public <TResource, Transcode> C1618i mo7020q(Class<TResource> cls, Class<Transcode> cls2, AbstractC1983e<TResource, Transcode> eVar) {
        this.f6583f.mo7627c(cls, cls2, eVar);
        return this;
    }
