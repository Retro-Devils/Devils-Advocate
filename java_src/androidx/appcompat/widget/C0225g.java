...
public class C0225g extends CheckBox implements AbstractC0420j, AbstractC1012r {

    /* renamed from: b */
    private final C0232i f999b;

    /* renamed from: c */
    private final C0218e f1000c;

    /* renamed from: d */
    private final C0297x f1001d;

    public C0225g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0754a.f3569r);
    }

    public C0225g(Context context, AttributeSet attributeSet, int i) {
    ...
    public void drawableStateChanged() {
        ...
        C0218e eVar = this.f1000c;
        if (eVar != null) {
            eVar.mo1383b();
        }
        C0297x xVar = this.f1001d;
        if (xVar != null) {
            xVar.mo1824b();
        }
    }
