...
public class C1416a extends C0225g {
    ...
    /* renamed from: e */
    private static final int f6046e = C1399j.Widget_MaterialComponents_CompoundButton_CheckBox;

    /* renamed from: f */
    private static final int[][] f6047f = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};

    /* renamed from: g */
    private ColorStateList f6048g;

    /* renamed from: h */
    private boolean f6049h;

    public C1416a(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1391b.f5678c);
    }
    ...
    public C1416a(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int r10 = p069c.p073b.p074a.p090b.C1400k.f5892h2
        ...
        L_0x0028:
            int r8 = p069c.p073b.p074a.p090b.C1400k.f5899i2
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f6048g == null) {
            ...
            this.f6048g = new ColorStateList(iArr, iArr2);
        }
        return this.f6048g;
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f6049h && C0412c.m2078b(this) == null) {
