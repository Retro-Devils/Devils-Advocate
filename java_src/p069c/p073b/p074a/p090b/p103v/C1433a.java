...
public class C1433a extends C0276s {
    ...
    /* renamed from: e */
    private static final int f6065e = C1399j.Widget_MaterialComponents_CompoundButton_RadioButton;

    /* renamed from: f */
    private static final int[][] f6066f = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};

    /* renamed from: g */
    private ColorStateList f6067g;

    /* renamed from: h */
    private boolean f6068h;

    public C1433a(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1391b.f5683t);
    }
    ...
    public C1433a(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int r10 = p069c.p073b.p074a.p090b.C1400k.f5913k2
        ...
        L_0x0028:
            int r8 = p069c.p073b.p074a.p090b.C1400k.f5920l2
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f6067g == null) {
            int c = C1428a.m7052c(this, C1391b.f5679f);
            ...
            this.f6067g = new ColorStateList(iArr, iArr2);
        }
        return this.f6067g;
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f6068h && C0412c.m2078b(this) == null) {
