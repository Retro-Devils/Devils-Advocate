...
public class C1408h {
    ...
    /* renamed from: a */
    private final C0838i<String, C1409i> f6027a = new C0838i<>();

    /* renamed from: b */
    private final C0838i<String, PropertyValuesHolder[]> f6028b = new C0838i<>();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f6027a.equals(((C1408h) obj).f6027a);
    }
    ...
    public long mo6465f() {
        ...
        long j = 0;
        for (int i = 0; i < size; i++) {
            C1409i m = this.f6027a.mo5016m(i);
    ...
    public void mo6469i(String str, C1409i iVar) {
        this.f6027a.put(str, iVar);
    }

    public String toString() {
        return '\n' + C1408h.class.getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f6027a + "}\n";
    }
}
