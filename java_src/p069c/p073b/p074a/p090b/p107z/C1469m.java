...
public class C1469m {
    ...
    /* renamed from: g */
    private final List<AbstractC1475f> f6213g = new ArrayList();

    /* renamed from: h */
    private final List<AbstractC1476g> f6214h = new ArrayList();
    ...
    class C1470a extends AbstractC1476g {
        ...
        public void mo6693a(Matrix matrix, C1447a aVar, int i, Canvas canvas) {
            for (AbstractC1476g gVar : this.f6216b) {
                gVar.mo6693a(this.f6217c, aVar, i, canvas);
            }
        }
    }
    ...
    public static class C1471b extends AbstractC1476g {
        ...
        /* renamed from: a */
        public void mo6693a(Matrix matrix, C1447a aVar, int i, Canvas canvas) {
            aVar.mo6579a(canvas, matrix, new RectF(this.f6219b.m7294k(), this.f6219b.m7298o(), this.f6219b.m7295l(), this.f6219b.m7293j()), i, this.f6219b.m7296m(), this.f6219b.m7297n());
        }
    }
    ...
    static class C1472c extends AbstractC1476g {
        ...
        /* renamed from: a */
        public void mo6693a(Matrix matrix, C1447a aVar, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.f6220b.f6231c - this.f6222d), (double) (this.f6220b.f6230b - this.f6221c)), 0.0f);
            Matrix matrix2 = new Matrix(matrix);
            matrix2.preTranslate(this.f6221c, this.f6222d);
        ...
        public float mo6694c() {
            return (float) Math.toDegrees(Math.atan((double) ((this.f6220b.f6231c - this.f6222d) / (this.f6220b.f6230b - this.f6221c))));
        }
    }
    ...
    public static class C1473d extends AbstractC1475f {
        ...
        /* renamed from: b */
        private static final RectF f6223b = new RectF();
        @Deprecated
    ...
    public static class C1474e extends AbstractC1475f {
        ...
        public void mo6695a(Matrix matrix, Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f6230b, this.f6231c);
            path.transform(matrix);
        }
    }
    ...
    public static abstract class AbstractC1475f {
        ...
        /* renamed from: a */
        protected final Matrix f6232a = new Matrix();
    ...
    public static abstract class AbstractC1476g {
        ...
        /* renamed from: a */
        static final Matrix f6233a = new Matrix();
    ...
    private void m7260b(float f) {
        if (m7262g() != f) {
            ...
            if (g <= 180.0f) {
                ...
                dVar.m7302s(m7262g());
                dVar.m7303t(g);
                this.f6214h.add(new C1471b(dVar));
                m7264p(f);
            }
        }
    }
    ...
    public void mo6683d(Matrix matrix, Path path) {
        ...
        for (int i = 0; i < size; i++) {
            this.f6213g.get(i).mo6695a(matrix, path);
        }
    }
    ...
    public AbstractC1476g mo6685f(Matrix matrix) {
        m7260b(m7263h());
        return new C1470a(new ArrayList(this.f6214h), matrix);
    }
