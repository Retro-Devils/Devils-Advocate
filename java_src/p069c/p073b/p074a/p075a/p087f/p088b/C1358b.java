...
public final class C1358b extends AbstractC3031a implements AbstractC2964k {
    ...
    public final Status mo6351g() {
        return this.f5629c == 0 ? Status.f9745b : Status.f9749f;
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a = C3034c.m12411a(parcel);
        C3034c.m12417g(parcel, 1, this.f5628b);
        C3034c.m12417g(parcel, 2, this.f5629c);
        C3034c.m12419i(parcel, 3, this.f5630d, i, false);
