...
public final class C1385l<TResult> {
    ...
    /* renamed from: b */
    private Queue<AbstractC1384k<TResult>> f5667b;
    @GuardedBy("mLock")
    ...
    public final void mo6434a(p069c.p073b.p074a.p075a.p089g.AbstractC1376d<TResult> r3) {
        /*
            r2 = this;
            java.lang.Object r0 = r2.f5666a
            monitor-enter(r0)
            java.util.Queue<c.b.a.a.g.k<TResult>> r1 = r2.f5667b     // Catch:{ all -> 0x002c }
            if (r1 == 0) goto L_0x002a
            boolean r1 = r2.f5668c     // Catch:{ all -> 0x002c }
            if (r1 == 0) goto L_0x000c
            goto L_0x002a
        L_0x000c:
            r1 = 1
            r2.f5668c = r1     // Catch:{ all -> 0x002c }
            monitor-exit(r0)     // Catch:{ all -> 0x002c }
        L_0x0010:
            java.lang.Object r1 = r2.f5666a
            monitor-enter(r1)
            java.util.Queue<c.b.a.a.g.k<TResult>> r0 = r2.f5667b     // Catch:{ all -> 0x0027 }
            java.lang.Object r0 = r0.poll()     // Catch:{ all -> 0x0027 }
            c.b.a.a.g.k r0 = (p069c.p073b.p074a.p075a.p089g.AbstractC1384k) r0     // Catch:{ all -> 0x0027 }
            if (r0 != 0) goto L_0x0022
            r3 = 0
            r2.f5668c = r3     // Catch:{ all -> 0x0027 }
    ...
    public final void mo6435b(AbstractC1384k<TResult> kVar) {
        synchronized (this.f5666a) {
            if (this.f5667b == null) {
                this.f5667b = new ArrayDeque();
            }
            this.f5667b.add(kVar);
        }
    }
}
