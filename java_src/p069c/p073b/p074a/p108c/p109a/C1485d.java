...
public class C1485d extends Fragment implements AbstractC1480c.AbstractC1484d {
    ...
    /* renamed from: Z */
    private final C1487b f6271Z = new C1487b();

    /* renamed from: a0 */
    private Bundle f6272a0;

    /* renamed from: b0 */
    private C1488e f6273b0;

    /* renamed from: c0 */
    private String f6274c0;

    /* renamed from: d0 */
    private AbstractC1480c.AbstractC1482b f6275d0;

    /* renamed from: e0 */
    private boolean f6276e0;
    ...
    private void m7330p2() {
        C1488e eVar = this.f6273b0;
        if (eVar != null && this.f6275d0 != null) {
            eVar.mo6725h(this.f6276e0);
            this.f6273b0.mo6721c(mo2552c0(), this, this.f6274c0, this.f6275d0, this.f6272a0);
            this.f6272a0 = null;
            this.f6275d0 = null;
        }
    }
    ...
    public void mo2537W0(Bundle bundle) {
        ...
        this.f6272a0 = bundle != null ? bundle.getBundle("YouTubePlayerSupportFragment.KEY_PLAYER_VIEW_STATE") : null;
    }

    @Override // androidx.fragment.app.Fragment
    /* renamed from: a1 */
    public View mo2547a1(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.f6273b0 = new C1488e(mo2552c0(), null, 0, this.f6271Z);
        m7330p2();
        return this.f6273b0;
    }
    ...
    public void mo2550b1() {
        if (this.f6273b0 != null) {
            ActivityC0447d c0 = mo2552c0();
            this.f6273b0.mo6727k(c0 == null || c0.isFinishing());
        }
        super.mo2550b1();
    }
    ...
    public void mo2556d1() {
        this.f6273b0.mo6729m(mo2552c0().isFinishing());
        this.f6273b0 = null;
        super.mo2556d1();
    }
    ...
    public void mo2585m1() {
        this.f6273b0.mo6728l();
        super.mo2585m1();
    }

    /* renamed from: q2 */
    public void mo6711q2(String str, AbstractC1480c.AbstractC1482b bVar) {
        this.f6274c0 = C1494b.m7375c(str, "Developer key cannot be null or empty");
        this.f6275d0 = bVar;
        m7330p2();
    }
    ...
    public void mo2603s1(Bundle bundle) {
        ...
        C1488e eVar = this.f6273b0;
        bundle.putBundle("YouTubePlayerSupportFragment.KEY_PLAYER_VIEW_STATE", eVar != null ? eVar.mo6737q() : this.f6272a0);
    }
    ...
    public void mo2605t1() {
        super.mo2605t1();
        this.f6273b0.mo6720b();
    }

    @Override // androidx.fragment.app.Fragment
    /* renamed from: u1 */
    public void mo2608u1() {
        this.f6273b0.mo6736p();
        super.mo2608u1();
    }
}
