...
/* renamed from: c.b.a.c.a.f.t */
public final class C1532t {
    /* renamed from: a */
    public static Map<String, String> m7511a(Locale locale) {
        ...
        m7512b(hashMap, locale.getLanguage());
        ...
        sb.append("_");
        sb.append(valueOf2);
        m7512b(hashMap, sb.toString());
        return hashMap;
    }

    /* renamed from: b */
    private static void m7512b(Map<String, String> map, String str) {
        if ("af".equals(str)) {
