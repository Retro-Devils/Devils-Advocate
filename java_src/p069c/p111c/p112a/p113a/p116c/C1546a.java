...
public class C1546a extends RecyclerView {
    ...
    /* renamed from: I0 */
    private static final String f6367I0 = C1546a.class.getSimpleName();

    /* renamed from: J0 */
    private static boolean f6368J0 = false;

    /* renamed from: K0 */
    private CarouselLayoutManager f6369K0;

    /* renamed from: L0 */
    private AbstractC1558l f6370L0 = CarouselLayoutManager.f11031t;

    /* renamed from: M0 */
    private boolean f6371M0;

    /* renamed from: N0 */
    private boolean f6372N0;

    /* renamed from: O0 */
    private boolean f6373O0;

    /* renamed from: P0 */
    private boolean f6374P0;

    /* renamed from: Q0 */
    private AbstractC1556j f6375Q0;

    /* renamed from: R0 */
    private AbstractC1553g f6376R0;

    /* renamed from: S0 */
    private AbstractC1554h f6377S0;

    /* renamed from: T0 */
    private AbstractC1555i f6378T0;

    /* renamed from: U0 */
    private int f6379U0 = Integer.MIN_VALUE;

    /* renamed from: V0 */
    private float f6380V0 = 0.0f;

    /* renamed from: W0 */
    private boolean f6381W0;

    /* renamed from: X0 */
    private boolean f6382X0 = false;

    /* renamed from: Y0 */
    private RecyclerView.AbstractC0678t f6383Y0 = new C1547a();
    ...
    class C1547a extends RecyclerView.AbstractC0678t {
        ...
        public void mo4177a(RecyclerView recyclerView, int i) {
            ...
            if (i == 0) {
                float e2 = C1546a.this.f6369K0.mo11173e2();
                int round = Math.round(e2);
                if (C1546a.this.f6372N0 && C1546a.this.f6369K0.mo11171c2() != 0.0f) {
                    if (Math.abs(e2 - ((float) round)) > 0.1f) {
                        C1546a.m7571P1("> scroll idle %f %f", new Object[]{Float.valueOf(e2 - C1546a.this.f6380V0), Float.valueOf(C1546a.this.f6369K0.mo11176j2().mo6826a(e2 - C1546a.this.f6380V0))});
                        round = (int) (C1546a.this.f6369K0.mo11176j2().mo6826a(e2 - C1546a.this.f6380V0) > 0.0f ? Math.ceil((double) e2) : Math.floor((double) e2));
                    }
                    C1546a.this.mo3237s1(round);
                } else if (C1546a.this.f6381W0) {
                    C1546a.this.m7568M1(round);
                }
                C1546a.this.f6381W0 = false;
            } else if (i == 1) {
                C1546a aVar = C1546a.this;
                aVar.f6380V0 = aVar.f6369K0.mo11173e2();
            }
            if (C1546a.this.f6375Q0 != null) {
                C1546a aVar2 = (C1546a) recyclerView;
                C1546a.this.f6375Q0.mo6864d(aVar2, i);
                if (i == 0) {
                    C1546a.this.f6375Q0.mo6863c(aVar2);
                } else if (i == 1) {
                    C1546a.this.f6375Q0.mo6862b(aVar2);
                } else if (i == 2) {
                    C1546a.this.f6375Q0.mo6861a(aVar2);
                }
            }
        }
        ...
        public void mo4178b(RecyclerView recyclerView, int i, int i2) {
            ...
            if (C1546a.this.f6375Q0 != null) {
                ...
                C1546a.this.f6375Q0.mo6865e(aVar, i, i2);
                C1546a.this.f6375Q0.mo6866f(aVar, (int) Math.floor((double) C1546a.this.f6369K0.mo11173e2()), C1546a.this.f6369K0.mo11169B2((int) Math.floor((double) C1546a.this.f6369K0.mo11173e2())), C1546a.this.f6369K0.mo11171c2());
            }
        }
    }
    ...
    class C1548b implements AbstractC1553g {
        ...
        public void mo6857a(RecyclerView.AbstractC0658g gVar, View view, int i, int i2) {
            if (C1546a.this.f6374P0) {
                C1546a.this.mo3237s1(i);
            }
            if (C1546a.this.f6376R0 != null) {
                C1546a.this.f6376R0.mo6857a(C1546a.this.getAdapter(), view, i, i2);
            }
        }
    }
    ...
    class C1549c implements AbstractC1554h {
        ...
        public boolean mo6858a(RecyclerView.AbstractC0658g gVar, View view, int i, int i2) {
            if (C1546a.this.f6376R0 != null) {
                return C1546a.this.f6377S0.mo6858a(C1546a.this.getAdapter(), view, i, i2);
            }
            return false;
        }
    }
    ...
    static /* synthetic */ class C1550d {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                p069c.p111c.p112a.p113a.p116c.C1546a.C1550d.f6387a = r0
            ...
            L_0x0012:
                int[] r0 = p069c.p111c.p112a.p113a.p116c.C1546a.C1550d.f6387a     // Catch:{ NoSuchFieldError -> 0x001d }
                c.c.a.a.c.a$e r1 = p069c.p111c.p112a.p113a.p116c.C1546a.EnumC1551e.Wheel     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = p069c.p111c.p112a.p113a.p116c.C1546a.C1550d.f6387a     // Catch:{ NoSuchFieldError -> 0x0028 }
                c.c.a.a.c.a$e r1 = p069c.p111c.p112a.p113a.p116c.C1546a.EnumC1551e.CoverFlow     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = p069c.p111c.p112a.p113a.p116c.C1546a.C1550d.f6387a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = p069c.p111c.p112a.p113a.p116c.C1546a.C1550d.f6387a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = p069c.p111c.p112a.p113a.p116c.C1546a.C1550d.f6387a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = p069c.p111c.p112a.p113a.p116c.C1546a.C1550d.f6387a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    private void m7568M1(int i) {
        AbstractC1555i iVar = this.f6378T0;
        if (iVar != null) {
            int i2 = this.f6379U0;
            if (!(i2 == Integer.MIN_VALUE || i2 == i)) {
                iVar.mo6859a(this, i2, this.f6369K0.mo11169B2(i2), getAdapter());
            }
            this.f6378T0.mo6860b(this, i, this.f6369K0.mo11169B2(i), getAdapter());
        } else {
            this.f6382X0 = true;
        }
        this.f6379U0 = i;
    ...
    private void m7569N1() {
        ...
        this.f6376R0 = null;
        this.f6377S0 = null;
        super.setOnScrollListener(this.f6383Y0);
    }
    ...
    public static void m7571P1(String str, Object... objArr) {
        ...
        if (objArr.length > 0) {
            Log.d(f6367I0, String.format(str, objArr));
        } else {
            Log.d(f6367I0, str);
        }
    }
    ...
    private void setTransformerInternal(AbstractC1558l lVar) {
        this.f6370L0 = lVar;
        this.f6369K0.mo11168A2(lVar);
    }

    /* renamed from: Q1 */
    public C1546a mo6839Q1(int i) {
        this.f6369K0.mo11184u2(this, i);
        return this;
    }
    ...
    public int getCurrentAdapterPosition() {
        CarouselLayoutManager carouselLayoutManager = this.f6369K0;
        return carouselLayoutManager.mo11169B2(carouselLayoutManager.mo11172d2());
    }

    public float getCurrentOffset() {
        return this.f6369K0.mo11171c2();
    }

    public int getCurrentPosition() {
        return this.f6369K0.mo11172d2();
    }

    public float getCurrentPositionPoint() {
        return this.f6369K0.mo11173e2();
    }

    public int getExtraVisibleChilds() {
        return this.f6369K0.mo11174f2();
    }

    public int getGravity() {
        return this.f6369K0.mo11175g2();
    }
    ...
    public AbstractC1558l getTransformer() {
        return this.f6369K0.mo11177k2();
    }

    @Override // androidx.recyclerview.widget.RecyclerView
    /* renamed from: k1 */
    public void mo3233k1(int i) {
        if (this.f6369K0.mo11179m2(i)) {
            super.mo3233k1(i);
            m7568M1(i);
        }
    }
    ...
    public void onAttachedToWindow() {
        ...
        mo3233k1(this.f6369K0.mo11172d2());
    }
    ...
    public void setDisplayMode(EnumC1551e eVar) {
        AbstractC1558l lVar;
        switch (C1550d.f6387a[eVar.ordinal()]) {
            case 1:
                lVar = new C1541e();
                break;
            case 2:
    ...
    public void setLayoutManagerInternal(CarouselLayoutManager carouselLayoutManager) {
        if (carouselLayoutManager != null) {
            ...
            this.f6369K0 = carouselLayoutManager;
            carouselLayoutManager.mo11186w2(this.f6371M0);
            mo6839Q1(1);
            this.f6369K0.mo11187x2(new C1548b());
            this.f6369K0.mo11188y2(new C1549c());
            return;
        }
        throw new NullPointerException("CarouselLayoutManager cannot be null");
    }
    ...
    public void setYTranslation(float f) {
        AbstractC1558l lVar = this.f6370L0;
        if (lVar != null) {
            lVar.mo6833a(f);
        }
    }
