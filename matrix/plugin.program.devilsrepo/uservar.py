...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR orange][B]Devils Wizard[/B][/COLOR]'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B] Devils Wizard [/B][/COLOR][COLOR {color2}]--[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '--[COLOR orange][B]Devils Wizard[/B][/COLOR]--'
